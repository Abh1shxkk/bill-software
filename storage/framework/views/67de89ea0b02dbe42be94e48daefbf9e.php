<?php $__env->startSection('title', 'Stock Transfer Incoming'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <div>
    ...
    <a href="<?php echo e(route('admin.stock-transfer-incoming.modification')); ?>" class="btn btn-warning btn-sm">
...
<div class="card shadow-sm border-0 rounded">
  <div class="card mb-4">
    <div class="card-body">
      <form method="GET" action="<?php echo e(route('admin.stock-transfer-incoming.index')); ?>" class="row g-3" id="filterForm">
        <div class="col-md-3">
          <label for="filter_by" class="form-label">Filter By</label>
          <select class="form-select" id="filter_by" name="filter_by">
            <option value="trf_no" <?php echo e(request('filter_by', 'trf_no') == 'trf_no' ? 'selected' : ''); ?>>Trf No.</option>
            <option value="supplier_name" <?php echo e(request('filter_by') == 'supplier_name' ? 'selected' : ''); ?>>Supplier Name</option>
            <option value="total_amount" <?php echo e(request('filter_by') == 'total_amount' ? 'selected' : ''); ?>>Total Amount</option>
          </select>
        </div>
        <div class="col-md-5">
      ...
      <tbody id="sti-table-body">
        <?php $__empty_1 = true; $__currentLoopData = $transactions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td><?php echo e($transaction->trf_no ?? '-'); ?></td>
            ...
            <td class="text-end">
              <span class="badge bg-success">₹<?php echo e(number_format($transaction->total_amount ?? 0, 2)); ?></span>
            </td>
            <td class="text-end">
              <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('admin.stock-transfer-incoming.show', $transaction->id)); ?>" title="View Details">
                <i class="bi bi-eye"></i>
              </a>
              <a class="btn btn-sm btn-outline-primary" href="<?php echo e(route('admin.stock-transfer-incoming.modification')); ?>?id=<?php echo e($transaction->id); ?>" title="Edit">
                <i class="bi bi-pencil"></i>
              </a>
              <button type="button" class="btn btn-sm btn-outline-danger delete-sti" 
                      data-id="<?php echo e($transaction->id); ?>" 
                      data-trf-no="<?php echo e($transaction->trf_no); ?>" 
                      data-supplier="<?php echo e($transaction->supplier ? $transaction->supplier->name : ($transaction->supplier_name ?? 'Unknown')); ?>"
                      title="Delete">
  ...
  <div class="card-footer bg-light d-flex flex-column gap-2">
    ...
    <?php if($transactions->hasMorePages()): ?>
      ...
      <div id="sti-sentinel" data-next-url="<?php echo e($transactions->appends(request()->query())->nextPageUrl()); ?>" style="height: 1px;"></div>
    <?php endif; ?>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  function deleteTransaction(id, modal) {
    ...
    fetch(`<?php echo e(url('admin/stock-transfer-incoming')); ?>/${id}`, {
      method: 'DELETE',
      headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/stock-transfer-incoming/index.blade.php ENDPATH**/ ?>