<?php $__env->startSection('title', 'Payment to Supplier'); ?>
                ...
                <div class="row g-2">
                    <div class="col-md-4">
                        <div class="field-group mb-2">
                            ...
                            <input type="date" class="form-control" id="paymentDate" value="<?php echo e(date('Y-m-d')); ?>" style="width: 130px;">
                        ...
                        <div class="field-group mb-2">
                            ...
                            <input type="text" class="form-control readonly-field" id="trnNo" value="<?php echo e($nextTrnNo); ?>" readonly style="width: 80px;">
                        </div>
...
function openAdjustmentModalDirect() {
    ...
    fetch(`<?php echo e(url('admin/supplier-payment/supplier-outstanding')); ?>/${supplierId}?page=1&per_page=100`)
        .then(r => r.json())
        .then(data => {
            if (data.success && data.outstanding) {
...
function savePayment() {
    ...
    fetch('<?php echo e(route("admin.supplier-payment.store")); ?>', {
        method: 'POST',
    ...
    .then(result => {
        if (result.success) {
            ...
            window.location.href = '<?php echo e(route("admin.supplier-payment.index")); ?>';
        } else {
...
<script>
// ============================================================
// AUTO-SAVE  —  supplier_payment_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'supplier_payment_transaction_autosave_v1';
let _t = null;
...
function restore(){
    ...
    _banner(state.savedAt, function keep(){
        ...
        (state.rows||[]).forEach(function(saved){
            ...
            // Restore bank details into JS object
            ...
            tr.innerHTML=
                ...
                '<td><input type="text" class="form-control cheque-no" data-row="'+ri+'" placeholder="Cheque No"></td>'+
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/supplier-payment/transaction.blade.php ENDPATH**/ ?>