    ...
    <div class="auth-container">
        ...
        <div class="auth-form-side">
            <div class="form-content">
                <div class="logo-area">
                    <img src="<?php echo e(asset('https://res.cloudinary.com/dz8p5iadt/image/upload/v1766408874/m-white-logo-01_mxmf6y.svg')); ?>" alt="Medi BillSuite" style="height: 40px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="auth-footer" style="justify-content: center; gap: 0.5rem;">
                        ...
                        <a href="<?php echo e(route('register.organization.form')); ?>" class="link highlight">Register Organization</a>
                    </div>
                </form>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\bill-software\bill-software\resources\views/auth/login.blade.php ENDPATH**/ ?>