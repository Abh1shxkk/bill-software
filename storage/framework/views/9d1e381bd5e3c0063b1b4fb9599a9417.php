<?php $__env->startSection('title', 'Debit Note Modification'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <a href="<?php echo e(route('admin.debit-note.transaction')); ?>" class="btn btn-danger btn-sm">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="searchDebitNoteNo" placeholder="Enter Debit Note No." 
                           value="<?php echo e($preloadDebitNoteNo ?? ''); ?>">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body py-2">
            <div class="d-flex justify-content-between">
                <div>
                    <button type="button" class="btn btn-secondary" id="cancelBtn" onclick="window.location.href='<?php echo e(route('admin.debit-note.invoices')); ?>'">
...
function fetchParties(query) {
    ...
    fetch('<?php echo e(route("admin.debit-note.search-parties")); ?>?q=' + encodeURIComponent(query) + '&party_type=' + currentPartyType)
...
function searchDebitNote() {
    ...
    fetch(`<?php echo e(url('admin/debit-note/fetch')); ?>/${encodeURIComponent(debitNoteNo)}`)
...
function updateDebitNote() {
    ...
    fetch(`<?php echo e(url('admin/debit-note')); ?>/${debitNoteId}`, {
        method: 'PUT',
        headers: {
...
function openDebitNotesModal() {
    ...
    fetch('<?php echo e(route("admin.debit-note.invoices")); ?>?all=1', {
        headers: { 
...
function openAdjustmentModal() {
    ...
    Promise.all([
        fetch(`<?php echo e(url('admin/debit-note/supplier')); ?>/${partyId}/purchase-invoices`).then(r => r.json()),
        fetch(`<?php echo e(url('admin/debit-note/supplier')); ?>/${partyId}/credit-notes`).then(r => r.json()),
        fetch(`<?php echo e(url('admin/debit-note')); ?>/${debitNoteId}/adjustments`).then(r => r.json())
    ])
...
function saveAdjustments() {
    ...
    // Save adjustments
    fetch(`<?php echo e(url('admin/debit-note')); ?>/${debitNoteId}/save-adjustments`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/debit-note/modification.blade.php ENDPATH**/ ?>