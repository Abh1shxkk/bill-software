<?php $__env->startSection('title', 'Quotation - Transaction'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.quotation.index')); ?>" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-md-2">
                                <div class="field-group">
                                    ...
                                    <input type="date" id="quotation_date" name="date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" onchange="updateDayName()" required>
                                </div>
                                <div class="field-group mt-1">
                                    <label style="width: 40px;"></label>
                                    <input type="text" id="day_name" class="form-control readonly-field text-center" value="<?php echo e(date('l')); ?>" readonly style="width: 100px;">
                                </div>
                                <div class="field-group mt-1">
                                    <label style="width: 40px;">T.No :</label>
                                    <input type="text" id="quotation_no" class="form-control readonly-field" value="<?php echo e($nextQuotationNo ?? ''); ?>" readonly style="width: 100px;">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="field-group mb-1">
                                    ...
                                    <div class="custom-dropdown-container w-100">
                                        ...
                                        <div id="customerDropdown" class="custom-dropdown-list">
                                            ...
                                            <div class="custom-dropdown-item" data-id="<?php echo e($customer->id); ?>" data-name="<?php echo e($customer->name); ?>"><?php echo e($customer->name); ?></div>
...
function searchItemsAjax(search = '', page = 1) {
    ...
    fetch(`<?php echo e(route("admin.quotation.searchItems")); ?>?q=${encodeURIComponent(search)}&page=${page}`)
...
function showBatchModal(item) {
    ...
    fetch(`<?php echo e(url('admin/quotation/get-batches')); ?>/${item.id}`)
        .then(response => response.json())
        .then(batches => {
            let batchRows = '';
...
function saveQuotation() {
    ...
    fetch('<?php echo e(route("admin.quotation.store")); ?>', {
        method: 'POST',
    ...
    .then(result => {
        if (result.success) {
            ...
            window.location.href = '<?php echo e(route("admin.quotation.index")); ?>';
        } else {
...
<script>
// ============================================================
// AUTO-SAVE  —  quotation_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'quotation_transaction_autosave_v1';
let _t = null;
...
function restore(){
    ...
    _banner(state.savedAt, function keep(){
        if(state.quotation_id) _set('quotation_id', state.quotation_id);
...
document.addEventListener('DOMContentLoaded', function(){
    setTimeout(function(){
        // markAsSaving fires right before every save fetch → clear draft
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/quotation/transaction.blade.php ENDPATH**/ ?>