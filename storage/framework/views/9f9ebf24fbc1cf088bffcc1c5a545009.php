<?php $__env->startSection('title', 'Stock Adjustment Transaction'); ?>
            ...
            <div class="header-section">
                <div class="header-row">
                    <div class="field-group">
                        ...
                        <input type="date" class="form-control" id="adjustmentDate" name="adjustment_date" style="width: 140px;" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" class="form-control readonly-field" id="trnNo" name="trn_no" style="width: 70px;" value="<?php echo e($nextTrnNo); ?>" readonly>
                    </div>
...
function saveTransaction() {
    ...
    fetch('<?php echo e(route("admin.stock-adjustment.store")); ?>', {
        method: 'POST',
        headers: {
