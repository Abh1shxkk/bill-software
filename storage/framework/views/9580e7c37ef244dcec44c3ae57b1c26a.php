...
<script>
    window.INDEX_SHORTCUTS_CONFIG = {
        ...
        isDynamic: <?php echo e($hasIndexHotkeys ? 'true' : 'false'); ?>,
        
        // Category configuration for help panel
        categories: <?php echo json_encode($indexCategoryConfig, 15, 512) ?>,
        
        // Hotkeys grouped by category for help panel
        categoryHotkeys: <?php echo json_encode($indexCategoryHotkeys, 15, 512) ?>,
        
        // All index shortcuts
        <?php if($hasIndexHotkeys): ?>
        shortcuts: <?php echo json_encode($indexShortcuts, 15, 512) ?>
        <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\bill-software\resources\views/layouts/partials/index-shortcuts-config.blade.php ENDPATH**/ ?>