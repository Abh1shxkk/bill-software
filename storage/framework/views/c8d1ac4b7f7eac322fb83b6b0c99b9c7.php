<?php $__env->startSection('title', 'Expiry Ledger - ' . $item->name); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h4 class="mb-0 d-flex align-items-center">
            <i class="bi bi-calendar-x me-2"></i> Expiry Ledger - <?php echo e($item->name); ?>

        </h4>
        <div class="text-muted small">Item: <?php echo e($item->name); ?> | Company: <?php echo e($item->company->name ?? 'N/A'); ?></div>
    </div>
...
<div class="card shadow-sm border-0 rounded">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.items.expiry-ledger', $item->id)); ?>" class="row g-3">
                <div class="col-md-4">
...
<script>
    ...
    const fromDate = '<?php echo e($fromDate); ?>';
    const toDate = '<?php echo e($toDate); ?>';
    ...
    function loadLedgerData() {
        ...
        // Fetch data
        fetch(`<?php echo e(route('admin.items.expiry-ledger.data')); ?>?item_id=${itemId}&from_date=${fromDate}&to_date=${toDate}`)
    ...
    function viewTransactionDetails(transactionId) {
        fetch(`<?php echo e(url('admin/breakage-expiry/transaction')); ?>/${transactionId}/details`)
            .then(response => response.json())
            .then(data => {
                if (data.success) {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/items/expiry-ledger.blade.php ENDPATH**/ ?>