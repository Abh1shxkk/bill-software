<?php $__env->startSection('title', 'Replacement Received Modification'); ?>
            ...
            <div class="card-body p-2">
                <form id="rnForm">
                    ...
                    <div class="d-flex justify-content-between pt-2 border-top">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm" onclick="window.location='<?php echo e(route('admin.replacement-received.index')); ?>'">
...
function loadTransaction(id) {
    fetch(`<?php echo e(url('admin/replacement-received/details')); ?>/${id}`)
        .then(r => r.json())
        .then(d => {
            if (d.success) {
    ...
    fetch(`<?php echo e(url('admin/replacement-received/supplier-purchase-returns')); ?>/${supplierId}`)
        ...
        .then(data => {
            if (data.success) {
                ...
                fetch(`<?php echo e(url('admin/replacement-received/adjustments')); ?>/${currentTransactionId}`)
                    .then(r => r.json())
                    .then(adjData => {
...
function submitTransaction() {
    ...
    fetch(`<?php echo e(url('admin/replacement-received/update')); ?>/${currentTransactionId}`, {
        method: 'POST',
...
function deleteTransaction() {
    ...
    fetch(`<?php echo e(url('admin/replacement-received')); ?>/${currentTransactionId}`, {
        method: 'DELETE',
...
function openInsertInvoiceModal() {
    fetch('<?php echo e(route("admin.replacement-received.past-transactions")); ?>')
        .then(r => r.json())
        .then(d => {
