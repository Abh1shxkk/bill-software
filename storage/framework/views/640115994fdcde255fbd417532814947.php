        ...
        <table class="main-table">
                ...
                <td colspan="5" style="width: 35%; border: none; border-bottom: 1px solid #000; padding: 5px;">
                    <table style="width: 100%; border: none;">
                        <tr>
                            ...
                            <td style="border: none; font-weight: bold;"><?php echo e($transaction->invoice_no); ?></td>
                            <td style="border: none; text-align: right;" rowspan="2">Page: 1 of 1</td>
                        </tr>
                        <tr>
                            <td style="border: none; font-weight: bold;">Dated</td>
                            <td style="border: none; font-weight: bold;"><?php echo e($transaction->sale_date ? $transaction->sale_date->format('d/m/Y') : ''); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="7" style="border: none; border-bottom: 1px solid #000; padding: 5px; vertical-align: top;">
                    <div class="text-bold" style="font-size: 11px;">To, <?php echo e(strtoupper($customer->name ?? 'CUSTOMER')); ?></div>
                    ...
                    <div class="text-right text-bold" style="margin-top: 5px;">PAN: <?php echo e($customer->pan_number ?? ''); ?></div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="14" style="font-size: 8px; padding: 2px 5px;">
                    SGST : &lt;0%&gt; 0.00 &lt;2.5%&gt; <?php echo e(number_format($sgst, 2)); ?> on <?php echo e(number_format($taxableAmount, 2)); ?> &lt;6%&gt; 0.00 on 0.00 &lt;9%&gt; 0.00 on 0.00 &lt;14%&gt; 0.00 on 0.00
                </td>
            </tr>
            <tr>
                <td colspan="14" style="font-size: 8px; padding: 2px 5px;">
                    CGST : &lt;0%&gt; 0.00 &lt;2.5%&gt; <?php echo e(number_format($cgst, 2)); ?> on <?php echo e(number_format($taxableAmount, 2)); ?> &lt;6%&gt; 0.00 on 0.00 &lt;9%&gt; 0.00 on 0.00 &lt;14%&gt; 0.00 on 0.00
                </td>
            </tr>
            ...
            <tr>
                <td colspan="7" class="footer-section" style="vertical-align: top; padding: 5px;">
                    ...
                    ACK DT:<?php echo e($transaction->sale_date ? $transaction->sale_date->format('d/m/Y') : date('d/m/Y')); ?><br><br>
...
<?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/sale/invoice-print-format1.blade.php ENDPATH**/ ?>