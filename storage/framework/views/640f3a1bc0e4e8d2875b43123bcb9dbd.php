...
<body>
    <div class="email-container">
        ...
        <p>Hello <strong><?php echo e($userName); ?></strong>,</p>
        ...
        <div class="footer">
            ...
            <p style="margin: 5px 0; font-size: 12px;">Generated on <?php echo e(now()->format('d M Y, h:i A')); ?></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\bill-software\resources\views/emails/otp.blade.php ENDPATH**/ ?>