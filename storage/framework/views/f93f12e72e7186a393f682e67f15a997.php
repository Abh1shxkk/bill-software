<?php $__env->startSection('title', 'Sale Challan Transaction'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        <a href="<?php echo e(route('admin.sale-challan.invoices')); ?>" class="btn btn-primary">
                ...
                <div class="d-flex gap-3">
                    ...
                    <div style="min-width: 220px; border: 1px solid #ccc; padding: 8px; background: #f5f5f5;">
                        <div class="field-group mb-2">
                            ...
                            <input type="date" class="form-control" name="date" id="challanDate" value="<?php echo e(date('Y-m-d')); ?>" style="width: 120px;" onchange="updateDayName()">
                            <input type="text" class="form-control readonly-field" id="dayName" value="<?php echo e(date('l')); ?>" readonly style="width: 85px; margin-left: 5px;">
                        </div>
                        <div class="field-group">
                            <label style="width: 80px;">Challan No.</label>
                            <span style="margin-right: 5px;">:</span>
                            <input type="text" class="form-control" name="challan_no" id="challanNo" value="<?php echo e($nextChallanNo); ?>" style="width: 80px; background-color: #f8f9fa;">
                        </div>
                    </div>
                        ...
                        <div class="field-group mb-2">
                            ...
                            <div class="searchable-dropdown" id="salesmanDropdownWrapper" style="width: 170px;">
                                ...
                                <select class="form-control no-select2"
                                    ...
                                    <?php $__currentLoopData = $salesmen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($salesman->id); ?>" data-name="<?php echo e($salesman->name); ?>" data-code="<?php echo e($salesman->code ?? ''); ?>"><?php echo e($salesman->code ?? ''); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
function loadPaginatedItems(page, isInitial = false, searchTerm = '') {
    ...
    let url = `<?php echo e(route("admin.sale-challan.getItems")); ?>?page=${page}&per_page=${itemsPerPage}`;
    if (searchTerm) {
...
function fetchCustomerDue() {
    ...
    fetch(`<?php echo e(url('admin/sale-challan/customer')); ?>/${customerId}/due`, {
        method: 'GET',
        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/sale-challan/transaction.blade.php ENDPATH**/ ?>