<?php $__env->startSection('title', 'Replacement Note Invoices'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <a href="<?php echo e(route('admin.replacement-note.modification')); ?>" class="btn btn-warning btn-sm">
...
<div class="card shadow-sm border-0 rounded">
    ...
    <div class="card mb-0 border-0">
        <div class="card-body py-3">
            <form method="GET" action="<?php echo e(route('admin.replacement-note.index')); ?>" class="row g-3" id="rn-filter-form">
                <div class="col-md-2">
                    ...
                    <select class="form-select form-select-sm" id="search_field" name="filter_by">
                        <option value="rn_no" <?php echo e(request('filter_by', 'rn_no') == 'rn_no' ? 'selected' : ''); ?>>RN No.</option>
                        <option value="supplier_name" <?php echo e(request('filter_by') == 'supplier_name' ? 'selected' : ''); ?>>Supplier Name</option>
                        <option value="net_amount" <?php echo e(request('filter_by') == 'net_amount' ? 'selected' : ''); ?>>Amount</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <label for="search" class="form-label small mb-1">Search</label>
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" id="rn-search" name="search" value="<?php echo e(request('search')); ?>" placeholder="Type to search..." autocomplete="off">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('admin.replacement-note.index')); ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-x-lg"></i> Clear</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <table class="table table-hover align-middle mb-0" style="font-size: 12px;">
            ...
            <tbody id="rn-table-body">
                ...
                <tr>
                    ...
                    <td><span class="badge bg-primary"><?php echo e($transaction->rn_no); ?></span></td>
                    ...
                    <td class="text-end fw-semibold">₹<?php echo e(number_format($transaction->net_amount ?? 0, 2)); ?></td>
                    <td>
                        <span class="badge bg-<?php echo e($transaction->status == 'active' ? 'success' : 'secondary'); ?>">
                            <?php echo e(ucfirst($transaction->status ?? 'active')); ?>

                        </span>
                    </td>
                    <td class="text-end">
                        <a href="<?php echo e(route('admin.replacement-note.show', $transaction->id)); ?>" class="btn btn-sm btn-outline-info" title="View">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="<?php echo e(route('admin.replacement-note.modification')); ?>?id=<?php echo e($transaction->id); ?>" class="btn btn-sm btn-outline-warning" title="Edit">
                            <i class="bi bi-pencil"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-outline-danger ajax-delete" 
                                data-url="<?php echo e(route('admin.replacement-note.destroy', $transaction->id)); ?>"
                                data-name="RN No: <?php echo e($transaction->rn_no); ?>"
                                title="Delete">
    ...
    <div class="card-footer bg-light d-flex flex-column gap-2">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div>Showing <?php echo e($transactions->firstItem() ?? 0); ?>-<?php echo e($transactions->lastItem() ?? 0); ?> of <?php echo e($transactions->total()); ?></div>
        ...
        <div id="rn-sentinel" data-next-url="<?php echo e($transactions->appends(request()->query())->nextPageUrl()); ?>" style="height: 1px;"></div>
        <?php endif; ?>
    </div>
</div>
...
window.performRnSearch = function() {
    ...
    fetch(`<?php echo e(route('admin.replacement-note.index')); ?>?${params.toString()}`, {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/replacement-note/index.blade.php ENDPATH**/ ?>