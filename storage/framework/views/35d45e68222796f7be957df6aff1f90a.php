<?php $__env->startSection('title', 'Pending Orders - ' . $item->name); ?>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <div style="margin-top: 10px; font-size: 13px;">
                        <strong>Item:</strong> <?php echo e($item->name); ?> | 
                        <strong>Packing:</strong> <?php echo e($item->packing ?? '1*1'); ?> | 
                        <strong>Qty:</strong> <?php echo e($item->getTotalQuantity()); ?>
            ...
            <table class="pending-table" style="width: 100%; margin-bottom: 0;">
                ...
                <tbody>
                    <tr style="background: #fff3cd; font-weight: bold;">
                        ...
                        <td style="text-align: center;"><?php echo e($item->getTotalQuantity()); ?></td>
                        <td></td>
                    </tr>
                    <?php if($pendingOrders->count() > 0): ?>
                        <?php $__currentLoopData = $pendingOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="pending-row order-row-<?php echo e($order->id); ?> supplier-row" 
                                data-supplier-mobile="<?php echo e($order->supplier->mobile ?? 'N/A'); ?>"
                                data-supplier-telephone="<?php echo e($order->supplier->telephone ?? 'N/A'); ?>"
                                style="cursor: pointer;">
                                <!-- Supplier Name -->
                                <td>
                                    <?php echo e(strtoupper($order->supplier->name ?? 'N/A')); ?>

                                </td>
                                <!-- Order Date -->
                                <td style="text-align: center;"><?php echo e($order->order_date ? \Carbon\Carbon::parse($order->order_date)->format('d-M-y') : '-'); ?></td>
                                <!-- Rate -->
                                ...
                                <td style="text-align: center;">-</td>
                                <!-- Qty -->
                                <td style="text-align: center; font-weight: bold;" class="qty-display-<?php echo e($order->id); ?>">
                                    <?php echo e(($order->order_qty ?? 0) + ($order->free_qty ?? 0)); ?>
                            ...
                            <tr class="edit-row-<?php echo e($order->id); ?>" style="display: none; background: #e7f3ff; border: 2px solid #0d6efd;">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 20px; justify-content: center;">
                                        <div style="display: flex; align-items: center; gap: 8px;">
                                            ...
                                            <input type="number" 
                                                ...
                                                id="edit-qty-<?php echo e($order->id); ?>" 
                                                value="<?php echo e($order->order_qty ?? 0); ?>" 
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px;">
                                            ...
                                            <input type="number" 
                                                class="form-control form-control-sm" 
                                                id="edit-free-<?php echo e($order->id); ?>" 
                                                value="<?php echo e($order->free_qty ?? 0); ?>" 
                                                style="width: 120px; font-size: 14px; text-align: center; font-weight: bold;">
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.save-qty-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Send AJAX request
            const url = `<?php echo e(url('/admin/items/pending-orders')); ?>/${orderId}/update-qty`;
            fetch(url, {
                method: 'PUT',
                headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/items/pending-orders.blade.php ENDPATH**/ ?>