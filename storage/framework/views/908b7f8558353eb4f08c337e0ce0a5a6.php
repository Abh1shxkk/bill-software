<?php $__env->startSection('title', 'Credit Note Invoices'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        <a href="<?php echo e(route('admin.credit-note.transaction')); ?>" class="btn btn-primary">
...
<div class="card shadow-sm border-0 rounded">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.credit-note.invoices')); ?>" class="row g-3" id="filterForm">
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="filter_by" name="filter_by">
                        ...
                        <option value="credit_note_no" <?php echo e(request('filter_by') == 'credit_note_no' ? 'selected' : ''); ?>>CN No.</option>
    ...
    <div class="table-responsive" id="cn-table-wrapper" style="position: relative; min-height: 400px; max-height: 600px; overflow-y: auto;">
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody id="cn-table-body">
                <?php $__empty_1 = true; $__currentLoopData = $creditNotes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e(($creditNotes->currentPage() - 1) * $creditNotes->perPage() + $loop->iteration); ?></td>
                        <td><?php echo e($cn->credit_note_date ? $cn->credit_note_date->format('d/m/Y') : '-'); ?></td>
                        <td><strong><?php echo e($cn->credit_note_no ?? '-'); ?></strong></td>
                        <td>
                            <?php if($cn->credit_party_type == 'S'): ?>
                                <span class="badge bg-info">Supplier</span>
                            <?php else: ?>
                                <span class="badge bg-warning text-dark">Customer</span>
                            <?php endif; ?>
                        </td>
                        <td><?php echo e($cn->credit_party_name ?? '-'); ?></td>
                        <td class="text-end">
                            <span class="badge bg-success">₹<?php echo e(number_format($cn->cn_amount ?? 0, 2)); ?></span>
                        </td>
                        <td class="text-end">
                            <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('admin.credit-note.show', $cn->id)); ?>" title="View Details">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a class="btn btn-sm btn-outline-primary" href="<?php echo e(route('admin.credit-note.modification')); ?>?credit_note_no=<?php echo e($cn->credit_note_no); ?>" title="Edit">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <button type="button" class="btn btn-sm btn-outline-danger delete-cn" 
                                    data-cn-id="<?php echo e($cn->id); ?>" 
                                    data-cn-no="<?php echo e($cn->credit_note_no); ?>" 
                                    data-party="<?php echo e($cn->credit_party_name ?? 'Unknown'); ?>"
                                    title="Delete">
    ...
    <div class="card-footer bg-light d-flex flex-column gap-2">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div>Showing <?php echo e($creditNotes->firstItem() ?? 0); ?>-<?php echo e($creditNotes->lastItem() ?? 0); ?> of <?php echo e($creditNotes->total() ?? 0); ?></div>
            <div class="text-muted">Page <?php echo e($creditNotes->currentPage()); ?> of <?php echo e($creditNotes->lastPage()); ?></div>
        </div>
        <?php if($creditNotes->hasMorePages()): ?>
            ...
            <div id="cn-sentinel" data-next-url="<?php echo e($creditNotes->appends(request()->query())->nextPageUrl()); ?>" style="height: 1px;"></div>
        <?php endif; ?>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function deleteCreditNote(cnId, modal) {
        ...
        fetch(`<?php echo e(url('admin/credit-note')); ?>/${cnId}`, {
            method: 'DELETE',
            headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/credit-note/invoices.blade.php ENDPATH**/ ?>