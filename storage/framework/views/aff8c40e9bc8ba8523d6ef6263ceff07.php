<?php $__env->startSection('title','Sale Invoices'); ?>
...
<div class="card shadow-sm border-0 rounded">
  <div class="card mb-4">
    <div class="card-body">
      <form method="GET" action="<?php echo e(route('admin.sale.invoices')); ?>" class="row g-3" id="filterForm">
        <div class="col-md-3">
          <label for="filter_by" class="form-label">Filter By</label>
          <select class="form-select" id="filter_by" name="filter_by">
            <option value="customer_name" <?php echo e(request('filter_by', 'customer_name') == 'customer_name' ? 'selected' : ''); ?>>Customer Name</option>
            <option value="invoice_no" <?php echo e(request('filter_by') == 'invoice_no' ? 'selected' : ''); ?>>Invoice No.</option>
            <option value="salesman_name" <?php echo e(request('filter_by') == 'salesman_name' ? 'selected' : ''); ?>>Salesman</option>
            <option value="invoice_amount" <?php echo e(request('filter_by') == 'invoice_amount' ? 'selected' : ''); ?>>Invoice Amount</option>
          </select>
        </div>
        <div class="col-md-5">
    ...
    <table class="table table-hover align-middle mb-0">
      ...
      <tbody id="sale-table-body">
        <?php $__empty_1 = true; $__currentLoopData = $sales ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          ?>
          <tr class="<?php echo e($isTemp ? 'table-warning' : ''); ?>">
            <td><?php echo e(($sales->currentPage() - 1) * $sales->perPage() + $loop->iteration); ?></td>
            <td><?php echo e($sale->sale_date ? $sale->sale_date->format('d/m/Y') : '-'); ?></td>
            ...
            <td><?php echo e($sale->due_date ? $sale->due_date->format('d/m/Y') : '-'); ?></td>
            <td class="text-end">
              <span class="badge bg-success">₹<?php echo e(number_format($sale->net_amount ?? 0, 2)); ?></span>
            </td>
            <td class="text-end">
              <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('admin.sale.show', $sale->id)); ?>" title="View Sale Details">
                <i class="bi bi-eye"></i>
              </a>
              <?php if($isTemp): ?>
                
                <a class="btn btn-sm btn-warning" href="<?php echo e(route('admin.sale.modification')); ?>?invoice_no=<?php echo e($sale->invoice_no); ?>&mode=finalize" title="Finalize Transaction">
                  <i class="bi bi-check-circle"></i>
                </a>
              <?php else: ?>
                
                <a class="btn btn-sm btn-outline-primary" href="<?php echo e(route('admin.sale.modification')); ?>?invoice_no=<?php echo e($sale->invoice_no); ?>" title="Edit Sale">
                  <i class="bi bi-pencil"></i>
                </a>
              <?php endif; ?>
              <button type="button" class="btn btn-sm btn-outline-danger delete-sale" 
                      data-sale-id="<?php echo e($sale->id); ?>" 
                      data-invoice-no="<?php echo e($sale->invoice_no); ?>" 
                      data-customer="<?php echo e($sale->customer->name ?? 'Unknown'); ?>"
                      title="Delete Sale">
  ...
  <div class="card-footer bg-light d-flex flex-column gap-2">
    <div class="d-flex justify-content-between align-items-center w-100">
      <div>Showing <?php echo e($sales->firstItem() ?? 0); ?>-<?php echo e($sales->lastItem() ?? 0); ?> of <?php echo e($sales->total() ?? 0); ?></div>
      <div class="text-muted">Page <?php echo e($sales->currentPage()); ?> of <?php echo e($sales->lastPage()); ?></div>
    </div>
    <?php if($sales->hasMorePages()): ?>
      ...
      <div id="sale-sentinel" data-next-url="<?php echo e($sales->appends(request()->query())->nextPageUrl()); ?>" style="height: 1px;"></div>
    <?php endif; ?>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  function deleteSale(saleId, modal) {
    ...
    const baseUrl = '<?php echo e(url("/admin/sale")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/sale/invoices.blade.php ENDPATH**/ ?>