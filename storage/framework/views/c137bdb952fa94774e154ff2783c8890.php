...
<script>
// ============================================================
// AUTO-SAVE  —  replacement_note_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'replacement_note_transaction_autosave_v1';
let _t = null;
...
function save(){
    ...
    const state={
        ...
        scm_percent:_val('scm_percent'),
        scm_amount:_val('scm_amount'),
...
function restore(){
    ...
    _banner(state.savedAt, function keep(){
        ...
        _set('scm_percent',state.scm_percent||'0');
        _set('scm_amount',state.scm_amount||'0.00');
        ...
        (state.rows||[]).forEach(function(saved){
            ...
            tr.innerHTML=
                '<td><input type="text" class="form-control" name="items['+ri+'][code]" value="'+_esc(saved.code)+'" readonly onclick="handleCodeKeydown(event,'+ri+')"></td>'+
                ...
                '<td><input type="number" class="form-control text-end" name="items['+ri+'][qty]" value="'+_esc(saved.qty||1)+'" step="1" onchange="calculateRowAmount('+ri+')" onkeydown="handleQtyKeydown(event,'+ri+')"></td>'+
                ...
                '<td><input type="number" class="form-control text-end" name="items['+ri+'][amount]" value="'+_esc(saved.amount||'0.00')+'" readonly></td>'+
