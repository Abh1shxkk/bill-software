...
(function() {
    ...
    function modalKeyCaptureHandler_<?php echo e(str_replace('-', '_', $id)); ?>(e) {
        ...
        if (e.key === 'ArrowLeft' || e.key === 'ArrowRight') {
            ...
            var curIdx = sortOrder.indexOf(currentSortOption_<?php echo e(str_replace('-', '_', $id)); ?>);
            ...
            currentSortOption_<?php echo e(str_replace('-', '_', $id)); ?> = newSort;
            /* Click the corresponding radio button to update UI */
            var radioIds = { 'expiry': '<?php echo e($id); ?>SortExpiry', 'last_purchase': '<?php echo e($id); ?>SortLastPurchase', 'purchase_history': '<?php echo e($id); ?>SortPurchaseHistory' };
            var radio = document.getElementById(radioIds[newSort]);
            if (radio) { radio.checked = true; }
            sortBatches_<?php echo e(str_replace('-', '_', $id)); ?>(newSort);
            selectedRowIndex_<?php echo e(str_replace('-', '_', $id)); ?> = -1;
            /* Keep focus on search input */
            setTimeout(function() { var s = document.getElementById('<?php echo e($id); ?>Search'); if (s) s.focus(); }, 0);
            return;
        }
