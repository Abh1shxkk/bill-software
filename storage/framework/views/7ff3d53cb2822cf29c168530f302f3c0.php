<?php $__env->startSection('title', 'Purchase Return Br.Expiry Adjustment - Modification'); ?>
...
<div class="bsi-form">
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('admin.breakage-supplier.received-transaction')); ?>" class="btn btn-success btn-sm py-0">
...
function loadInvoices() {
    fetch('<?php echo e(route("admin.breakage-supplier.get-received-past-invoices")); ?>')
        .then(r => r.json())
        .then(data => {
...
function selectInvoice(id) {
    closeInvoiceModal();
    fetch(`<?php echo e(url('admin/breakage-supplier/received-details')); ?>/${id}`)
        .then(r => r.json())
        .then(data => {
...
function openAdjustmentModal() {
    ...
    const url = `<?php echo e(url('admin/breakage-supplier/supplier-purchases')); ?>/${currentSupplierId}`;
...
function updateTransaction() {
    ...
    fetch(`<?php echo e(url('admin/breakage-supplier/update-received')); ?>/${currentTransactionId}`, {
        method: 'POST',
...
function deleteTransaction() {
    ...
    fetch(`<?php echo e(url('admin/breakage-supplier/delete-received')); ?>/${currentTransactionId}`, {
        method: 'DELETE',
...
function cancelTransaction() {
    window.location.href = '<?php echo e(route("admin.breakage-supplier.received-transaction")); ?>';
}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/breakage-supplier/received-modification.blade.php ENDPATH**/ ?>