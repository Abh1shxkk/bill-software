...
<?php $__env->startSection('content'); ?>
  ...
  <div class="card shadow-sm border-0 rounded">
    <div class="card mb-4">
      <div class="card-body">
        <form method="GET" action="<?php echo e(route('admin.suppliers.index')); ?>" class="row g-3" id="supplier-filter-form">
          <div class="col-md-3">
            ...
            <select class="form-select" id="search_field" name="search_field">
              ...
              <option value="name" <?php echo e(request('search_field') == 'name' ? 'selected' : ''); ?>>Split Name</option>
              <option value="code" <?php echo e(request('search_field') == 'code' ? 'selected' : ''); ?>>Alter Code</option>
              <option value="mobile" <?php echo e(request('search_field') == 'mobile' ? 'selected' : ''); ?>>Mobile</option>
              <option value="telephone" <?php echo e(request('search_field') == 'telephone' ? 'selected' : ''); ?>>Tel.</option>
              <option value="address" <?php echo e(request('search_field') == 'address' ? 'selected' : ''); ?>>Address</option>
              <option value="dl_no" <?php echo e(request('search_field') == 'dl_no' ? 'selected' : ''); ?>>DL No.</option>
              <option value="gst_no" <?php echo e(request('search_field') == 'gst_no' ? 'selected' : ''); ?>>GSTIN</option>
            </select>
          </div>
          <div class="col-md-6">
            <label for="search" class="form-label">Search</label>
            <div class="input-group">
              <input type="text" class="form-control" id="supplier-search" name="search" value="<?php echo e(request('search')); ?>"
        ...
        <tbody id="supplier-table-body">
          <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td>
                <div class="form-check">
                  <input class="form-check-input supplier-checkbox" type="checkbox" value="<?php echo e($supplier->supplier_id); ?>" id="supplier-<?php echo e($supplier->supplier_id); ?>">
                  <label class="form-check-label" for="supplier-<?php echo e($supplier->supplier_id); ?>">
                    <span class="visually-hidden">Select supplier</span>
                  </label>
                </div>
              </td>
              <td><?php echo e(($suppliers->currentPage() - 1) * $suppliers->perPage() + $loop->iteration); ?></td>
              <td><?php echo e($supplier->code); ?></td>
              <td><?php echo e($supplier->name); ?></td>
              <td><?php echo e($supplier->mobile ?: $supplier->telephone); ?></td>
              <td><?php echo e($supplier->email); ?></td>
              <td>₹<?php echo e(number_format($supplier->opening_balance, 2)); ?></td>

              <td class="text-end">
                <a class="btn btn-sm btn-outline-primary" href="<?php echo e(route('admin.suppliers.show', $supplier)); ?>"
                  title="View"><i class="bi bi-eye"></i></a>
                <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('admin.suppliers.ledger', $supplier)); ?>" 
                  title="Ledger"><i class="bi bi-journal-text"></i></a>
                <a class="btn btn-sm btn-outline-warning" href="<?php echo e(route('admin.suppliers.dues', $supplier)); ?>" 
                  title="Due List"><i class="bi bi-receipt"></i></a>
                <a class="btn btn-sm btn-outline-dark" href="<?php echo e(route('admin.suppliers.bills', $supplier)); ?>" 
                  title="List of Bills"><i class="bi bi-receipt-cutoff"></i></a>
                <a class="btn btn-sm btn-outline-success" href="<?php echo e(route('admin.suppliers.pending-orders', $supplier)); ?>" 
                  title="Pending Order (F7)"><i class="bi bi-cart-plus"></i></a>
                <a class="btn btn-sm btn-outline-secondary" href="<?php echo e(route('admin.suppliers.edit', $supplier)); ?>"
                  title="Edit"><i class="bi bi-pencil"></i></a>
                <form action="<?php echo e(route('admin.suppliers.destroy', $supplier)); ?>" method="POST"
                  class="d-inline ajax-delete-form">
                  <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                  <button type="button" class="btn btn-sm btn-outline-danger ajax-delete"
                    data-delete-url="<?php echo e(route('admin.suppliers.destroy', $supplier)); ?>"
    ...
    <div class="card-footer bg-light d-flex flex-column gap-2">
      <div class="align-self-start">Showing <?php echo e($suppliers->firstItem() ?? 0); ?>-<?php echo e($suppliers->lastItem() ?? 0); ?> of
      ...
      <?php if($suppliers->hasMorePages()): ?>
        ...
        <div id="supplier-sentinel" data-next-url="<?php echo e($suppliers->appends(request()->query())->nextPageUrl()); ?>"
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function performSearch() {
        ...
        fetch(`<?php echo e(route('admin.suppliers.index')); ?>?${params.toString()}`, {
          headers: {
    ...
    function confirmMultipleDeleteSuppliers() {
      ...
      window.GlobalMultipleDelete.show({
        ...
        deleteUrl: '<?php echo e(route('admin.suppliers.multiple-delete')); ?>',
        itemType: 'suppliers',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>