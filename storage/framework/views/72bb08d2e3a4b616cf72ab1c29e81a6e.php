<?php $__env->startSection('title', 'Purchase Voucher Modification'); ?>
...
function loadVouchersForModal() {
    fetch('<?php echo e(route("admin.purchase-voucher.get-vouchers")); ?>')
    .then(r => r.json())
...
function loadVoucher(id) {
    closeInvoiceModal();
    fetch(`<?php echo e(url('admin/purchase-voucher')); ?>/${id}/details`)
    .then(r => r.json())
...
function searchVoucher() {
    ...
    fetch(`<?php echo e(route('admin.purchase-voucher.search')); ?>?bill_no=${encodeURIComponent(billNo)}`)
    .then(r => r.json())
...
function updateVoucher() {
    ...
    fetch(`<?php echo e(url('admin/purchase-voucher')); ?>/${currentVoucherId}`, {
        method: 'PUT',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/purchase-voucher/modification.blade.php ENDPATH**/ ?>