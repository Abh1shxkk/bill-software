...
class ReceiptOCRPreview {
    constructor(options = {}) {
        this.options = {
            ocrApiUrl: options.ocrApiUrl || '<?php echo e(route("admin.api.ocr.extract")); ?>',
            itemSearchUrl: options.itemSearchUrl || '<?php echo e(route("admin.api.ocr.search-items")); ?>',
            batchApiUrl: options.batchApiUrl || '<?php echo e(url("admin/api/item-batches")); ?>',
            csrfToken: options.csrfToken || '<?php echo e(csrf_token()); ?>',
            ...options
        };
    ...
    async autoStraightenImage(imageData) {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("admin.api.ocr.straighten-image")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/sale/partials/receipt-ocr-preview.blade.php ENDPATH**/ ?>