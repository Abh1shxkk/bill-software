<?php $__env->startSection('title', 'Sample Issued'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <div>
    <a href="<?php echo e(route('admin.sample-issued.create')); ?>" class="btn btn-primary btn-sm">
...
<div class="card shadow-sm border-0 rounded">
  <div class="card mb-4">
    <div class="card-body">
      <form method="GET" action="<?php echo e(route('admin.sample-issued.index')); ?>" class="row g-3" id="filterForm">
        <div class="col-md-3">
      ...
      <tbody id="si-table-body">
        <?php $__empty_1 = true; $__currentLoopData = $transactions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td>
              <span class="badge bg-info"><?php echo e($transaction->party_type ?? '-'); ?></span>
            </td>
            ...
            <td class="text-end">
              <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('admin.sample-issued.show', $transaction->id)); ?>" title="View Details">
                <i class="bi bi-eye"></i>
              </a>
              <a class="btn btn-sm btn-outline-primary" href="<?php echo e(route('admin.sample-issued.modification')); ?>?load=<?php echo e($transaction->id); ?>" title="Edit">
  ...
  <div class="card-footer bg-light d-flex flex-column gap-2">
    ...
    <?php if($transactions->hasMorePages()): ?>
      ...
      <div id="si-sentinel" data-next-url="<?php echo e($transactions->appends(request()->query())->nextPageUrl()); ?>" style="height: 1px;"></div>
    <?php endif; ?>
  </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/sample-issued/index.blade.php ENDPATH**/ ?>