<?php $__env->startSection('title', 'Stock Ledger - ' . $item->name); ?>
<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h4 class="mb-0 d-flex align-items-center">
            <i class="bi bi-graph-up me-2"></i> Stock Ledger (F10) - <?php echo e($item->name); ?>

        </h4>
        <div class="text-muted small">Item: <?php echo e($item->name); ?> | Company: <?php echo e($item->company_short_name); ?></div>
    </div>
            ...
            <div class="card-body py-2">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h5 class="mb-0 text-success" id="total-received"><?php echo e(number_format($totalReceived, 0)); ?></h5>
                    </div>
            ...
            <div class="card-body py-2">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h5 class="mb-0 text-danger" id="total-issued"><?php echo e(number_format($totalIssued, 0)); ?></h5>
                    </div>
            ...
            <div class="card-body py-2">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h5 class="mb-0 text-primary" id="balance-qty"><?php echo e(number_format($balance, 0)); ?></h5>
                    </div>
            ...
            <div class="card-body py-2">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h5 class="mb-0 text-info" id="total-records"><?php echo e($ledgers->total()); ?></h5>
                    </div>
...
<div class="card shadow-sm border-0 rounded">
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.items.stock-ledger-complete', $item->id)); ?>" class="row g-3">
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="party_id" name="party_id">
                        ...
                        <optgroup label="Customers">
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="C<?php echo e($customer->id); ?>" <?php echo e($selectedPartyId == 'C'.$customer->id ? 'selected' : ''); ?>>
                                    <?php echo e($customer->name); ?> (<?php echo e($customer->code); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </optgroup>
                        <optgroup label="Suppliers">
                            <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="S<?php echo e($supplier->supplier_id); ?>" <?php echo e($selectedPartyId == 'S'.$supplier->supplier_id ? 'selected' : ''); ?>>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody id="ledger-table-body">
                <?php $__empty_1 = true; $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="<?php echo e($ledger['type'] === 'SALE_RETURN' ? 'table-success' : 
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php echo e($ledger['trans_no']); ?>

                        </td>
                        <td><?php echo e($ledger['date']); ?></td>
                        <td><?php echo e($ledger['party_name']); ?></td>
                        <td><?php echo e($ledger['batch']); ?></td>
                        <td class="text-center"><?php echo e($ledger['received_qty'] > 0 ? number_format($ledger['received_qty'], 0) : '-'); ?></td>
                        <td class="text-center"><?php echo e($ledger['received_free'] > 0 ? number_format($ledger['received_free'], 0) : '-'); ?></td>
                        <td class="text-center"><?php echo e($ledger['issued_qty'] > 0 ? number_format($ledger['issued_qty'], 0) : '-'); ?></td>
                        <td class="text-center"><?php echo e($ledger['issued_free'] > 0 ? number_format($ledger['issued_free'], 0) : '-'); ?></td>
                        <td><?php echo e(number_format($ledger['balance'], 0)); ?></td>
                        <td class="text-end">
                            <button class="btn btn-sm btn-outline-primary" 
                                onclick="viewStockLedgerDetails('<?php echo e($ledger['type']); ?>', '<?php echo e($ledger['transaction_id']); ?>')"
                                title="View Details">
                                <i class="bi bi-eye"></i>
                            </button>
                        </td>
    ...
    <div class="card-footer bg-light d-flex flex-column gap-2">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div>Showing <?php echo e($ledgers->firstItem() ?? 0); ?>-<?php echo e($ledgers->lastItem() ?? 0); ?> of <?php echo e($ledgers->total()); ?></div>
            <div class="text-muted">Page <?php echo e($ledgers->currentPage()); ?> of <?php echo e($ledgers->lastPage()); ?></div>
        </div>
        <?php if($ledgers->hasMorePages()): ?>
            ...
            <div id="ledger-sentinel" data-next-url="<?php echo e($ledgers->appends(request()->query())->nextPageUrl()); ?>" style="height: 1px;"></div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/items/stock-ledger-complete.blade.php ENDPATH**/ ?>