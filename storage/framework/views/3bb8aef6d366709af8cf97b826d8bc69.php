...
@media (max-width: 767px) {
    /* ── Outer form panel: full width ── */
    .bank-form { padding: 10px !important; }
    .bank-form-inner {
    ...
    /* ── Bank custom dropdown: full width ── */
    #bankDisplay { width: 100% !important; }
    #bankMenu    { width: 100% !important; }

    /* ── Footer buttons: full width ── */
    .footer-section .btn-action {
