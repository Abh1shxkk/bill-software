<?php $__env->startSection('title', 'Cheque Returned Unpaid'); ?>
...
<div class="card shadow-sm border-0 rounded">
    ...
    <div class="table-responsive" id="cheque-table-wrapper" style="position: relative; min-height: 400px;">
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody id="cheque-table-body">
                <?php $__empty_1 = true; $__currentLoopData = $chequeData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cheque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr data-id="<?php echo e($cheque['id']); ?>" data-cheque='<?php echo json_encode($cheque, 15, 512) ?>'>
                    <td><?php echo e($index + 1); ?></td>
                    <td><?php echo e($cheque['date']); ?></td>
                    <td><?php echo e($cheque['trn_no']); ?></td>
                    <td><?php echo e($cheque['customer_name'] ?? '-'); ?></td>
                    <td><?php echo e($cheque['bank_name']); ?></td>
                    <td><?php echo e($cheque['cheque_no']); ?></td>
                    <td class="text-end">
                        <span class="badge bg-success">₹<?php echo e(number_format($cheque['amount'], 2)); ?></span>
                    </td>
                    <td>
                        <?php if($cheque['status'] === 'pending'): ?>
                            <span class="badge bg-warning text-dark">Pending</span>
                        <?php elseif($cheque['status'] === 'returned'): ?>
                            <span class="badge bg-danger">Returned</span>
                        <?php else: ?>
                            <span class="badge bg-secondary">Cancelled</span>
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($cheque['status_date']); ?></td>
                    <td class="text-end">
                        <button type="button" class="btn btn-sm btn-outline-danger btn-return-single" 
                                data-id="<?php echo e($cheque['id']); ?>" 
                                data-cheque-no="<?php echo e($cheque['cheque_no']); ?>"
                                data-customer="<?php echo e($cheque['customer_name'] ?? '-'); ?>"
                                data-amount="<?php echo e(number_format($cheque['amount'], 2)); ?>"
                                title="Mark as Returned Unpaid"
                                <?php echo e($cheque['status'] !== 'pending' ? 'disabled' : ''); ?>>
                            <i class="bi bi-arrow-return-left"></i>
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-warning btn-cancel-single" 
                                data-id="<?php echo e($cheque['cheque_return_id']); ?>" 
                                data-cheque-no="<?php echo e($cheque['cheque_no']); ?>"
                                data-customer="<?php echo e($cheque['customer_name'] ?? '-'); ?>"
                                data-amount="<?php echo e(number_format($cheque['amount'], 2)); ?>"
                                title="Cancel Return"
                                <?php echo e($cheque['status'] !== 'returned' ? 'disabled' : ''); ?>>
    ...
    <div class="card-footer bg-light">
        <div class="d-flex justify-content-between align-items-center">
            <div>Showing <?php echo e(count($chequeData)); ?> cheques</div>
        </div>
    </div>
</div>
...
<div class="custom-modal" id="returnModal">
    ...
    <div class="custom-modal-body">
        ...
        <div class="custom-modal-form-row">
            ...
            <input type="date" id="returnDate" value="<?php echo e(date('Y-m-d')); ?>">
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirm-return').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("admin.cheque-return.return")); ?>', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('confirm-cancel').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("admin.cheque-return.cancel")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/cheque-return/index.blade.php ENDPATH**/ ?>