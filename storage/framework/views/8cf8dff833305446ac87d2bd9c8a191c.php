<?php $__env->startSection('title', 'Purchase Challan Transaction'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-receipt me-2"></i> Purchase Challan Transaction</h4>
        <div class="text-muted small">Create new purchase challan (pending order - not invoiced)</div>
    </div>
</div>
    ...
    <div class="card-body">
                <form id="purchaseChallanForm" method="POST" autocomplete="off" onsubmit="return false;">
                    ...
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-primary btn-sm" onclick="savePurchaseChallan()">
...
// Save Purchase Challan button click handler
function savePurchaseChallan() {
    ...
    const headerData = {
        ...
        // challan_no will be auto-generated by backend if not provided
        ...
        ft_amount: 0, // Purchase Challan uses ft_amount
    ...
    // 4. Send to backend
    const saveUrl = '<?php echo e(route('admin.purchase-challan.store')); ?>';
    ...
    .then(data => {
        if (data.success) {
            ...
            showSuccessModalWithReload('Purchase Challan saved successfully!\n\nChallan No: ' + data.challan_no);
        } else {
            // Show detailed error for other errors
            let errorMsg = '❌ Error saving purchase challan:\n\n';
    ...
    .catch(error => {
        console.error('Error:', error);
        let errorMsg = 'An error occurred while saving the purchase challan.\n\n';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/purchase-challan/transaction.blade.php ENDPATH**/ ?>