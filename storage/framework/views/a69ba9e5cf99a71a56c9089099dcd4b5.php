<?php $__env->startSection('title', 'Breakage/Expiry Dump - Transaction'); ?>
...
<div class="bsi-form">
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <a href="<?php echo e(route('admin.breakage-supplier.unused-dump-modification')); ?>" class="btn btn-outline-secondary btn-sm py-0"><i class="bi bi-list"></i> View All</a>
    </div>
...
function saveTransaction() {
    ...
    fetch('<?php echo e(route("admin.breakage-supplier.store-unused-dump")); ?>', {
        method: 'POST',
        headers: {
...
<script>
// ============================================================
// AUTO-SAVE  —  bsi_unused_dump_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'bsi_unused_dump_transaction_autosave_v1';
let _t = null;
...
function save(){
    ...
    if(!rows.length&&!state.narration) return;
...
function restore(){
    ...
    if(!state||(!state.rows.length&&!state.narration)) return;
...
document.addEventListener('DOMContentLoaded',function(){
    setTimeout(function(){
        ...
        window.fetch=function(url){
            ...
            if((url||'').toString().indexOf('store-unused-dump')!==-1){
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/breakage-supplier/unused-dump-transaction.blade.php ENDPATH**/ ?>