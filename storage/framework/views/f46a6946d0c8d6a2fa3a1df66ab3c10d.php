<?php $__env->startSection('title', 'Voucher Entry - Modification'); ?>
        ...
        <div class="search-section">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-md-5 text-end">
                    <a href="<?php echo e(route('admin.voucher-entry.transaction')); ?>" class="btn btn-success btn-sm"><i class="bi bi-plus"></i> New</a>
                    <a href="<?php echo e(route('admin.voucher-entry.index')); ?>" class="btn btn-secondary btn-sm"><i class="bi bi-list"></i> View All</a>
                </div>
            </div>
        </div>
...
function loadVoucher() {
    ...
    var url = '<?php echo e(url("admin/voucher-entry/get-by-voucher-no")); ?>/' + voucherNo;
...
function updateVoucher() {
    ...
    fetch('<?php echo e(url("admin/voucher-entry")); ?>/' + currentVoucherId, {
        method: 'PUT',
        ...
        body: JSON.stringify({
            ...
            items: items, _token: '<?php echo e(csrf_token()); ?>'
        })
    })
...
function deleteVoucher() {
    ...
    fetch('<?php echo e(url("admin/voucher-entry")); ?>/' + currentVoucherId, {
        method: 'DELETE', headers: { 'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>', 'Content-Type':'application/json' }
    })
    .then(function (r) { return r.json(); })
    .then(function (data) {
        if (data.success) { alert(data.message); window.location.href = '<?php echo e(route("admin.voucher-entry.index")); ?>'; }
...
function openBrowseModal() {
    ...
    var voucherType = document.getElementById('searchVoucherType').value;
    var url = '<?php echo e(route("admin.voucher-entry.get-vouchers")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/voucher-entry/modification.blade.php ENDPATH**/ ?>