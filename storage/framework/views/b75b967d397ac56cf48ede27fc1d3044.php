<?php $__env->startSection('title', 'Purchase Return Voucher'); ?>
...
@media (max-width: 767px) {
    ...
    /* ── Supplier dropdown (style="width:250px") ── */
...
<div class="card shadow-sm border-0">
    <div class="card-body compact-form">
        ...
        <div class="d-flex justify-content-center gap-3 mt-3">
            ...
            <button type="button" class="btn-hsn px-4" onclick="window.location.href='<?php echo e(route('admin.purchase-return-voucher.index')); ?>'"><i class="bi bi-x-circle me-1"></i> Exit</button>
        </div>
    </div>
</div>
...
function saveVoucher() {
    ...
    fetch('<?php echo e(route("admin.purchase-return-voucher.store")); ?>', {
        method: 'POST',
...
<script>
// ============================================================
// AUTO-SAVE  —  purchase_return_voucher_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'purchase_return_voucher_transaction_autosave_v1';
let _t = null;
...
function save(){
    ...
    const state={
        ...
        supplierId:_val('supplierSelect'),
        supplierDisplay:_val('supplierSearchInput'),
        remarks:_val('remarks'),
        rows:rows,
    };
    if(!state.supplierId && !rows.length) return;
...
function restore(){
    ...
    if(!state||(!state.supplierId&&!state.rows.length)) return;
    _banner(state.savedAt, function keep(){
        if(state.returnDate) _set('returnDate',state.returnDate);
        _set('supplierSelect',state.supplierId||'');
        _set('supplierSearchInput',state.supplierDisplay||'');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/purchase-return-voucher/transaction.blade.php ENDPATH**/ ?>