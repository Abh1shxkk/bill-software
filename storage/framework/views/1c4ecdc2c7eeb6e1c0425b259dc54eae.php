...
unset($__errorArgs, $__bag); ?>" name="name"
                                        value="<?php echo e(old('name')); ?>" placeholder="Item name">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($company->id); ?>"
                                                data-short-name="<?php echo e($company->short_name); ?>" <?php echo e(old('company_id') == $company->id ? 'selected' : ''); ?>>
                                                <?php echo e($company->name); ?> (<?php echo e($company->short_name); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="company_short_name"
                                        id="company_short_name" value="<?php echo e(old('company_short_name')); ?>" readonly style="background-color: #f0f0f0;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="packing" value="<?php echo e(old('packing')); ?>"
                                        placeholder="Packing">
                                </div>
                                <div class="col-md-1 mb-3">
                                    <label class="form-label">Unit</label>
                                    <input type="number" class="form-control" name="unit" value="<?php echo e(old('unit', 1)); ?>"
                                        readonly style="background-color: #f0f0f0;">
                                </div>
                                <div class="col-md-1 mb-3">
                                    <label class="form-label">Unit</label>
                                    <select class="form-select" name="unit_type">
                                        <option value="Unit" <?php echo e(old('unit_type', 'Unit') == 'Unit' ? 'selected' : ''); ?>>Unit</option>
                                        <option value="Kg." <?php echo e(old('unit_type') == 'Kg.' ? 'selected' : ''); ?>>Kg.</option>
                                        <option value="L." <?php echo e(old('unit_type') == 'L.' ? 'selected' : ''); ?>>L.</option>
                                        <option value="Gm." <?php echo e(old('unit_type') == 'Gm.' ? 'selected' : ''); ?>>Gm.</option>
                                        <option value="Ml." <?php echo e(old('unit_type') == 'Ml.' ? 'selected' : ''); ?>>Ml.</option>
                                        <option value="Doz." <?php echo e(old('unit_type') == 'Doz.' ? 'selected' : ''); ?>>Doz.</option>
                                        <option value="Mtr." <?php echo e(old('unit_type') == 'Mtr.' ? 'selected' : ''); ?>>Mtr.</option>
                                    </select>
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Mfg. By</label>
                                    <input type="text" class="form-control" name="mfg_by" value="<?php echo e(old('mfg_by')); ?>"
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="status" value="<?php echo e(old('status')); ?>"
                                        placeholder="Status">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Schedule</label>
                                    <input type="text" class="form-control" name="schedule"
                                        value="<?php echo e(old('schedule', '00')); ?>" placeholder="00">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-1 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="box_qty" value="<?php echo e(old('box_qty', 0)); ?>"
                                        placeholder="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Case Qty</label>
                                    <input type="number" class="form-control" name="case_qty"
                                        value="<?php echo e(old('case_qty', 0)); ?>" placeholder="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Min. Level</label>
                                    <input type="number" step="0.01" class="form-control" name="min_level"
                                        value="<?php echo e(old('min_level', 0)); ?>" placeholder="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Max. Level</label>
                                    <input type="number" step="0.01" class="form-control" name="max_level"
                                        value="<?php echo e(old('max_level', 0)); ?>" placeholder="0">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Bar Code</label>
                                    <input type="text" class="form-control" name="bar_code" value="<?php echo e(old('bar_code')); ?>"
                                        placeholder="Bar code">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Division</label>
                                    <input type="text" class="form-control" name="division"
                                        value="<?php echo e(old('division', '00')); ?>" placeholder="00">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="flag" value="<?php echo e(old('flag')); ?>"
                                        placeholder="Flag">
                                </div>
                                <div class="col-md-2 mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="narcotic_flag"
                                            id="narcotic_flag" value="Y" <?php echo e(old('narcotic_flag') == 'Y' ? 'checked' : ''); ?>>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="s_rate"
                                        value="<?php echo e(old('s_rate', '0.00')); ?>" placeholder="0.00">
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control" name="mrp"
                                            value="<?php echo e(old('mrp', '0.00')); ?>" placeholder="0.00">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control" name="ws_rate"
                                            value="<?php echo e(old('ws_rate', '0.00')); ?>" placeholder="0.00" style="max-width: 120px;">
                                        <select class="form-select" name="ws_net_toggle" style="max-width: 60px;">
                                            <option value="Y" <?php echo e(old('ws_net_toggle', 'Y') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                            <option value="N" <?php echo e(old('ws_net_toggle') == 'N' ? 'selected' : ''); ?>>N</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control" name="spl_rate"
                                            value="<?php echo e(old('spl_rate', '0.00')); ?>" placeholder="0.00" style="max-width: 120px;">
                                        <select class="form-select" name="spl_net_toggle" style="max-width: 60px;">
                                            <option value="Y" <?php echo e(old('spl_net_toggle', 'Y') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                            <option value="N" <?php echo e(old('spl_net_toggle') == 'N' ? 'selected' : ''); ?>>N</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="1" class="form-control" name="scheme_plus"
                                            value="<?php echo e(old('scheme_plus', 0)); ?>" placeholder="0" style="max-width: 80px;">
                                        <span class="input-group-text">+</span>
                                        <input type="number" step="1" class="form-control" name="scheme_minus"
                                            value="<?php echo e(old('scheme_minus', 0)); ?>" placeholder="0" style="max-width: 80px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="min_gp"
                                        value="<?php echo e(old('min_gp', '0.00')); ?>" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="pur_rate"
                                        value="<?php echo e(old('pur_rate', '0.00')); ?>" placeholder="0.00">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="cost"
                                        value="<?php echo e(old('cost', '0.00')); ?>" placeholder="0.00">
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="1" class="form-control" name="pur_scheme_plus"
                                            value="<?php echo e(old('pur_scheme_plus', 0)); ?>" placeholder="0" style="max-width: 80px;">
                                        <span class="input-group-text">+</span>
                                        <input type="number" step="1" class="form-control" name="pur_scheme_minus"
                                            value="<?php echo e(old('pur_scheme_minus', 0)); ?>" placeholder="0" style="max-width: 80px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="nr"
                                        value="<?php echo e(old('nr', '0.00')); ?>" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="hsn_code_input" name="hsn_code" 
                                               value="<?php echo e(old('hsn_code')); ?>" placeholder="Click to select HSN" readonly 
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="cgst_percent" name="cgst_percent"
                                        value="<?php echo e(old('cgst_percent', 0)); ?>" placeholder="0.00" readonly style="background-color: #f0f0f0;">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">SGST (%)</label>
                                    <input type="number" step="0.01" class="form-control" id="sgst_percent" name="sgst_percent"
                                        value="<?php echo e(old('sgst_percent', 0)); ?>" placeholder="0.00" readonly style="background-color: #f0f0f0;">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">IGST (%)</label>
                                    <input type="number" step="0.01" class="form-control" id="igst_percent" name="igst_percent"
                                        value="<?php echo e(old('igst_percent', 0)); ?>" placeholder="0.00" readonly style="background-color: #f0f0f0;">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Cess (%)</label>
                                    <input type="number" step="0.01" class="form-control" name="cess_percent"
                                        value="<?php echo e(old('cess_percent', 0)); ?>" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="0.01" class="form-control" name="vat_percent"
                                                value="<?php echo e(old('vat_percent', 0)); ?>" placeholder="0.00">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Fixed Dis. (Y/N/M)</label>
                                            <select class="form-select" name="fixed_dis">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('fixed_dis') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('fixed_dis') == 'N' ? 'selected' : ''); ?>>N</option>
                                                <option value="M" <?php echo e(old('fixed_dis') == 'M' ? 'selected' : ''); ?>>M</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="expiry_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('expiry_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('expiry_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="inclusive_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('inclusive_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('inclusive_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="generic_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('generic_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('generic_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Bar Code :</label>
                                            <select class="form-select" name="bar_code_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('bar_code_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('bar_code_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="h_scm_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('h_scm_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('h_scm_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Max Inv.Qty :</label>
                                            <input type="number" step="0.01" class="form-control" name="max_inv_qty_value"
                                                value="<?php echo e(old('max_inv_qty_value', 0)); ?>" placeholder="21332">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="q_scm_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('q_scm_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('q_scm_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Weight :</label>
                                            <input type="number" step="0.01" class="form-control" name="weight_new"
                                                value="<?php echo e(old('weight_new', 0)); ?>" placeholder="0.000">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="0.01" class="form-control" name="fixed_dis_percent"
                                                value="<?php echo e(old('fixed_dis_percent', 0)); ?>" placeholder="0.00">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Fixed Dis Type</label>
                                            <select class="form-select" name="fixed_dis_type">
                                                <option value="">-- Select --</option>
                                                <option value="W" <?php echo e(old('fixed_dis_type') == 'W' ? 'selected' : ''); ?>>W</option>
                                                <option value="R" <?php echo e(old('fixed_dis_type') == 'R' ? 'selected' : ''); ?>>R</option>
                                                <option value="I" <?php echo e(old('fixed_dis_type') == 'I' ? 'selected' : ''); ?>>I</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="def_qty_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('def_qty_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('def_qty_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Volume :</label>
                                            <input type="number" step="0.01" class="form-control" name="volume_new"
                                                value="<?php echo e(old('volume_new', 0)); ?>" placeholder="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-select" name="comp_name_bc_new">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('comp_name_bc_new') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('comp_name_bc_new') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="dpc_item_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('dpc_item_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('dpc_item_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="lock_sale_flag">
                                                <option value="">-- Select --</option>
                                                <option value="Y" <?php echo e(old('lock_sale_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                                <option value="N" <?php echo e(old('lock_sale_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="max_min_flag">
                                                <option value="">-- Select --</option>
                                                <option value="1" <?php echo e(old('max_min_flag') == '1' ? 'selected' : ''); ?>>1</option>
                                                <option value="2" <?php echo e(old('max_min_flag') == '2' ? 'selected' : ''); ?>>2</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">MRP for Sale</label>
                                            <input type="number" step="0.01" class="form-control" name="mrp_for_sale_new"
                                                value="<?php echo e(old('mrp_for_sale_new', 0)); ?>" placeholder="0.00">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-select" name="max_inv_qty_new">
                                                <option value="">-- Select --</option>
                                                <option value="W" <?php echo e(old('max_inv_qty_new') == 'W' ? 'selected' : ''); ?>>W</option>
                                                <option value="R" <?php echo e(old('max_inv_qty_new') == 'R' ? 'selected' : ''); ?>>R</option>
                                                <option value="I" <?php echo e(old('max_inv_qty_new') == 'I' ? 'selected' : ''); ?>>I</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="commodity" value="<?php echo e(old('commodity')); ?>" placeholder="">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Current Scheme :</label>
                                    <select class="form-select" name="current_scheme_flag" id="current_scheme_flag">
                                        <option value="">-- Select --</option>
                                        <option value="Y" <?php echo e(old('current_scheme_flag') == 'Y' ? 'selected' : ''); ?>>Y</option>
                                        <option value="N" <?php echo e(old('current_scheme_flag') == 'N' ? 'selected' : ''); ?>>N</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="1" class="form-control" name="scheme_plus_value"
                                            value="<?php echo e(old('scheme_plus_value', 0)); ?>" placeholder="0" style="max-width: 80px;">
                                        <span class="input-group-text">+</span>
                                        <input type="number" step="1" class="form-control" name="scheme_minus_value"
                                            value="<?php echo e(old('scheme_minus_value', 0)); ?>" placeholder="0" style="max-width: 80px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="from_date" value="<?php echo e(old('from_date')); ?>">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">To</label>
                                    <input type="date" class="form-control" name="to_date" value="<?php echo e(old('to_date')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="category" value="<?php echo e(old('category')); ?>" placeholder="">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="category_2" value="<?php echo e(old('category_2')); ?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="upc" value="<?php echo e(old('upc')); ?>" placeholder="">
                                </div>
                                <div class="col-md-6"></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bill-software\resources\views/admin/items/create.blade.php ENDPATH**/ ?>