...
class PurchaseChallanTransactionItem extends Model
{
    use HasFactory;

    protected $fillable = [
        'purchase_challan_transaction_id',
        'item_id',
        'batch_id',
        'batch_no',
        'expiry_date',
    ...
    {
        return $this->belongsTo(PurchaseChallanTransaction::class, 'purchase_challan_transaction_id');
    }
