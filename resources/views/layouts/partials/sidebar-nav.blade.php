{{-- Sidebar Navigation - All modules visible, access controlled by middleware --}}
@php
    $user = auth()->user();
@endphp
...
<nav class="nav flex-column small">
    ...
    <div class="mt-2">
        ...
        <div class="collapse" id="menuCompanies">
            <a class="nav-link ms-3 d-flex align-items-center" href="{{ route('admin.companies.create') }}">
    ...
    <div class="mt-2">
        ...
        <div class="collapse" id="menuCustomers">
            <a class="nav-link ms-3 d-flex align-items-center" href="{{ route('admin.customers.create') }}">
    ...
    <div class="mt-2">
        ...
        <div class="collapse" id="menuItems">
            <a class="nav-link ms-3 d-flex align-items-center" href="{{ route('admin.items.create') }}">
    ...
    <div class="mt-2">
        ...
        <div class="collapse" id="menuUserManagement">
            <a class="nav-link ms-3 d-flex align-items-center" href="{{ route('admin.users.create') }}">
                <span class="label">Add User</span>
            </a>
            <a class="nav-link ms-3 d-flex align-items-center" href="{{ route('admin.users.index') }}">
