...
@section('title', 'Sale Return Voucher Details')
@section('content')
<style>
    .detail-card { background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
    .detail-header { background: linear-gradient(135deg, #e53e3e, #c53030); color: white; padding: 15px 20px; border-radius: 8px 8px 0 0; }
    .detail-body { padding: 20px; }
    .info-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; margin-bottom: 20px; }
    .info-item { background: #f8f9fa; padding: 12px; border-radius: 6px; border-left: 3px solid #e53e3e; }
    ...
    .items-table th { background: #e53e3e; color: white; padding: 10px; text-align: center; }
    .items-table td { padding: 8px 10px; border-bottom: 1px solid #eee; }
    .items-table tr:hover { background: #f5f5f5; }
    .totals-box { background: #fff5f5; padding: 15px; border-radius: 6px; border: 1px solid #feb2b2; }
</style>

<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0"><i class="bi bi-eye me-2"></i>Sale Return Voucher Details</h5>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.sale-return-voucher.modification') }}?invoice_no={{ $voucher->sr_no }}" class="btn btn-warning btn-sm">
            <i class="bi bi-pencil me-1"></i>Edit
        </a>
        <a href="{{ route('admin.sale-return-voucher.index') }}" class="btn btn-secondary btn-sm">
...
<div class="detail-card">
    <div class="detail-header">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="mb-0"><i class="bi bi-receipt me-2"></i>SR No #{{ $voucher->sr_no }}</h6>
    ...
    <div class="detail-body">
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value">{{ $voucher->sr_no }}</div>
            </div>
            <div class="info-item">
            ...
            <div class="col-md-6 offset-md-6">
                <div class="totals-box">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <strong class="fs-5 text-danger">₹{{ number_format($voucher->net_amount ?? 0, 2) }}</strong>
                    </div>
                </div>
            </div>
        </div>
