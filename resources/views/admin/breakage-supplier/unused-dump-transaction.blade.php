...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h5 class="mb-0"><i class="bi bi-trash me-2"></i> Breakage/Expiry Dump - Transaction</h5>
            <div class="text-muted small">Process unused or dumped items</div>
        </div>
        <a href="{{ route('admin.breakage-supplier.unused-dump-modification') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="row g-3">
                    <div class="col-md-2">
                        ...
                        <div class="mb-0">
                            ...
                            <input type="text" id="trn_no" name="trn_no" class="form-control form-control-sm bg-light" value="477" readonly>
                        </div>
                    </div>
                    <div class="col-md-10">
                ...
                <div class="card-body p-1">
                    <div class="row g-1 align-items-center">
                        <div class="col-md-5 d-flex gap-2">
                            ...
                            <!-- GST Breakdown (Less relevant for Dump, but kept for consistency/layout) -->
                             <div class="input-group input-group-sm flex-nowrap" style="width: 100px;">
...
function showBatchModal(item) {
     const html = `
        ...
        <div class="custom-modal show" id="batchModal">
            ...
            <div class="custom-modal-body"><div id="batchContent"><div class="text-center">Loading...</div></div></div>
...
function selectBatch(batchId, batchNo, expiry, qty, mrp, pRate, sRate) {
    ...
    addItemRow({
        ...
        cl_qty: qty, cgst_percent: item.cgst||0, sgst_percent: item.sgst||0
    });
    closeBatchModal();
}
...
function updateFooter(row) {
    ...
    // Tax logic (Dump typically involves reversing tax or just expensing cost)
...
function calcRow(idx) {
    ...
    // Assuming dump might not calculate output tax, but let's keep logic if it was there
    // For now, Dump usually is just Cost. But let's assume Tax is 0 or relevant.
    // I will assume simple Cost calc for Dump.
    const taxAmt = 0; // Dump usually doesn't add tax.
