...
@section('title', 'Issued Transactions - Breakage/Expiry to Supplier')
...
function performSearch() {
    ...
    .catch(error => {
        ...
        if (pageElements.tbody) {
            pageElements.tbody.innerHTML = '<tr><td colspan="9" class="text-center text-danger">Error loading data</td></tr>';
        }
    })
    .finally(() => {
        isSearching = false;
