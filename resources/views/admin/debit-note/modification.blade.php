...
<script>
// ============================================================
// AUTO-SAVE  —  debit_note_modification_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'debit_note_modification_autosave_v1';
let _t = null;
...
function save(){
    ...
    if(!state.debitNoteId && !rows.length) return;
...
document.addEventListener('DOMContentLoaded',function(){
    setTimeout(function(){
        ...
        if(typeof updateDebitNote==='function'){
            const _orig=updateDebitNote;
            window.updateDebitNote=function(){ clearAutoSave(); _orig.apply(this,arguments); };
        }
    },800);
