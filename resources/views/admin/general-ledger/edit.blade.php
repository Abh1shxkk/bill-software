      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-3">
          ...
          <input type="date" class="form-control" 
                 id="birth_day" name="birth_day" value="{{ old('birth_day', $generalLedger->birth_day) }}">
        </div>

        <div class="col-md-3 mb-3">
          <label for="anniversary_day" class="form-label">A' Day</label>
          <input type="date" class="form-control" 
                 id="anniversary_day" name="anniversary_day" value="{{ old('anniversary_day', $generalLedger->anniversary_day) }}">
        </div>
      </div>
