...
<script>
// ============================================================
// AUTO-SAVE  —  purchase_voucher_modification_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'purchase_voucher_modification_autosave_v1';
let _t = null;
...
function restore(){
    ...
    _banner(state.savedAt, function keep(){
        ...
        (state.rows||[]).forEach(function(saved){
            ...
            tr.innerHTML=
                '<td><input type="text" class="hsn-code" data-row="'+ri+'" data-custom-enter="true" onclick="selectRow('+ri+')" onfocus="selectRow('+ri+')" placeholder="HSN"></td>'+
