...
<script>
// ============================================================
// AUTO-SAVE  —  purchase_voucher_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'purchase_voucher_transaction_autosave_v1';
let _t = null;
...
function restore(){
    ...
    _banner(state.savedAt, function keep(){
        ...
        (state.rows||[]).forEach(function(saved){
            ...
            tr.innerHTML=
                '<td><input type="text" class="hsn-code" data-row="'+ri+'" data-custom-enter="true" onclick="selectRow('+ri+')" onfocus="selectRow('+ri+')" placeholder="Enter HSN"></td>'+
                '<td><input type="number" class="amount" step="0.01" data-custom-enter="true" onchange="calculateRowTax('+ri+')" oninput="calculateRowTax('+ri+')" placeholder="0.00"></td>'+
                '<td><input type="number" class="gst-percent" step="0.01" data-custom-enter="true" onchange="calculateRowTax('+ri+')" placeholder="0"></td>'+
                '<td><input type="number" class="cgst-percent" step="0.01" readonly style="background:#e9ecef;"></td>'+
                '<td><input type="number" class="cgst-amount" step="0.01" readonly style="background:#e9ecef;"></td>'+
                '<td><input type="number" class="sgst-percent" step="0.01" readonly style="background:#e9ecef;"></td>'+
                '<td><input type="number" class="sgst-amount" step="0.01" readonly style="background:#e9ecef;"></td>'+
