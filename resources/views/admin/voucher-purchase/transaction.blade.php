            ...
            <div class="header-section">
                <div class="row g-2 align-items-center">
                    <div class="col-auto">
                        ...
                        <input type="date" class="form-control" name="voucher_date" id="voucherDate" value="{{ date('Y-m-d') }}" style="width: 120px;" tabindex="1">
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        ...
                        <input type="date" class="form-control" name="bill_date" id="billDate" value="{{ date('Y-m-d') }}" style="width: 120px;" tabindex="3">
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="col-auto" style="position:relative;">
                            ...
                            <div id="supplierMenu" style="
                                ...
                                <div id="supplierOpts">
                                    ...
                                    <div class="sup-opt"
                                         data-val="{{ $supplier->supplier_id }}"
                                         data-gst="{{ $supplier->gst_no }}"
                                         data-pan="{{ $supplier->pan }}"
                                         data-city="{{ $supplier->address }}"
                                         data-pin=""
                                         style="padding:5px 10px;cursor:pointer;font-size:11px;">{{ $supplier->name }}</div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
