...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <div>
    <a href="{{ route('admin.sample-received.create') }}" class="btn btn-primary btn-sm">
...
<div class="card shadow-sm border-0 rounded">
  <div class="card mb-4">
    <div class="card-body">
      <form method="GET" action="{{ route('admin.sample-received.index') }}" class="row g-3" id="filterForm">
        <div class="col-md-3">
      ...
      <tbody id="sr-table-body">
        @forelse($transactions ?? [] as $transaction)
          <tr>
            ...
            <td>
              <span class="badge bg-success">{{ $transaction->party_type ?? '-' }}</span>
            </td>
  ...
  <div class="card-footer bg-light d-flex flex-column gap-2">
    ...
    @if($transactions->hasMorePages())
      ...
      <div id="sr-sentinel" data-next-url="{{ $transactions->appends(request()->query())->nextPageUrl() }}" style="height: 1px;"></div>
    @endif
  </div>
</div>
