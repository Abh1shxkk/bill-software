...
@section('title', 'Sample Received - View Transaction')
...
<style>
    ...
    .table-items th { background: #90EE90; font-size: 11px; font-weight: 600; }
...
<section class="py-3">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h4 class="mb-0"><i class="bi bi-eye me-2"></i> Sample Received - View Transaction</h4>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('admin.sample-received.edit', $transaction->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card shadow-sm border-0 rounded">
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="detail-value">
                                <span class="badge bg-success badge-party">{{ $partyTypes[$transaction->party_type] ?? $transaction->party_type }}</span>
                            </div>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="detail-card" style="background: #d4edda;">
                            <div class="row">
                                <div class="col-6">
                ...
                <div class="d-flex justify-content-between mt-3">
                    <div>
                        <a href="{{ route('admin.sample-received.index') }}" class="btn btn-secondary">
                            <i class="bi bi-arrow-left me-1"></i> Back to List
                        </a>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.sample-received.edit', $transaction->id) }}" class="btn btn-primary">
                            <i class="bi bi-pencil me-1"></i> Modify
                        </a>
...
function cancelTransaction() {
    if (!confirm('Are you sure you want to cancel this sample received? Stock will be reversed.')) {
        return;
    }

    fetch('{{ route("admin.sample-received.destroy", $transaction->id) }}', {
        method: 'DELETE',
        headers: {
