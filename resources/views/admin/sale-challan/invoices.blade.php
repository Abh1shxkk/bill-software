...
@section('title','Sale Challan Invoices')
@section('content')

<div class="d-flex justify-content-between align-items-center mb-3">
  <div>
    <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-file-earmark-text me-2"></i> Sale Challan List</h4>
    <div class="text-muted small">View and manage all sale challans</div>
  </div>
  <div>
...
<div class="card shadow-sm border-0 rounded">
  <div class="card mb-4">
    <div class="card-body">
      <form method="GET" action="{{ route('admin.sale-challan.invoices') }}" class="row g-3" id="filterForm">
        <div class="col-md-2">
        ...
        @forelse($challans ?? [] as $challan)
          <tr>
            ...
            <td class="text-end">
              ...
              @if(!$challan->is_invoiced)
              <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.sale-challan.modification') }}?challan_no={{ $challan->challan_no }}" title="Edit Challan">
              ...
              <button type="button" class="btn btn-sm btn-outline-danger delete-challan" 
                      ...
                      data-customer="{{ $challan->customer->name ?? 'Unknown' }}"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to delete this sale challan?</p>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  function deleteChallan(challanId, modal) {
    ...
    fetch(`{{ url('admin/sale-challan') }}/${challanId}`, {
      method: 'DELETE',
      headers: {
