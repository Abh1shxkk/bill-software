            ...
            <div class="header-section">
                ...
                <div class="header-row">
                    ...
                    <div class="field-group">
                        ...
                        <input type="date" class="form-control" name="date" id="challanDate" value="{{ date('Y-m-d') }}" style="width: 140px;" onchange="updateDayName()">
...
async function loadInvoices(fromDate = null, toDate = null) {
    ...
    try {
        ...
        let url = '{{ route("admin.sale-challan.modification.challans") }}';
        if (fromDate && toDate) {
...
async function loadTransactionByInvoiceNo(invoiceNo) {
    try {
        ...
        const url = `{{ url('/admin/sale-challan/modification/search') }}?challan_no=${encodeURIComponent(invoiceNumber)}`;
        const response = await fetch(url);
