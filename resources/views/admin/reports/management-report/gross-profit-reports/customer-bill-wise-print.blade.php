...
<html>
<head>
    <title>Gross Profit - Customer Wise - Print</title>
    <style>
...
<body onload="window.print()">
    <div class="header">
        <h3>Gross Profit - Customer Wise</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-end" style="width: 13%;">Sale Amt</th>
                <th class="text-end" style="width: 13%;">Pur Amt</th>
