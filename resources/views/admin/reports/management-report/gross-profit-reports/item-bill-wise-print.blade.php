...
<html>
<head>
    <title>Gross Profit - Item Wise - Print</title>
    <style>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-center" style="width: 8%;">Inv No</th>
                <th style="width: 25%;">Item Name</th>
                <th class="text-center" style="width: 6%;">Qty</th>
                <th class="text-end" style="width: 9%;">Sale Rate</th>
                <th class="text-end" style="width: 9%;">Pur Rate</th>
                <th class="text-end" style="width: 10%;">Sale Amt</th>
                <th class="text-end" style="width: 10%;">Pur Amt</th>
                <th class="text-end" style="width: 8%;">GP Amt</th>
                <th class="text-end" style="width: 6%;">GP %</th>
            </tr>
        </thead>
        <tbody>
            @php
