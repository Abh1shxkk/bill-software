...
<div class="container-fluid">
    ...
    <div class="card shadow-sm" style="background-color: #f0f0f0;">
        <div class="card-body p-3">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.management.gross-profit.customer-bill-wise') }}">
...
function printReport() {
    window.open('{{ route("admin.reports.management.gross-profit.customer-bill-wise") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
