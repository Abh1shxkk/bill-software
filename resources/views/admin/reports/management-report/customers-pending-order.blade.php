...
@section('title', "Customer's Pending Orders")

@section('content')
<div class="container-fluid">
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 text-primary fst-italic fw-bold" style="font-family: 'Times New Roman', serif;">Customer's Pending Orders</h4>
        </div>
    </div>

    <div class="card shadow-sm" style="background-color: #f0f0f0;">
        <div class="card-body p-3">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.management.customers-pending-order') }}">
                <!-- From & To Date -->
                ...
                <div class="row g-2 mb-2 align-items-center">
                    ...
                    <div class="col-auto">
                        <input type="text" name="customer_code" class="form-control form-control-sm text-uppercase" value="{{ request('customer_code') }}" style="width: 120px;">
                    </div>
                    <div class="col-auto">
                        <select name="customer_id" class="form-select form-select-sm" style="width: 300px;">
                ...
                <table class="table table-bordered table-sm mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ number_format($row['delivered_qty'], 2) }}</td>
...
function printReport() {
    window.open('{{ route("admin.reports.management.customers-pending-order") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
