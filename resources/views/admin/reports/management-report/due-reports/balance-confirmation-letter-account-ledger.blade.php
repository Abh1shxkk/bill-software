...
@section('title', 'Balance Confirmation Letter - Account Ledger')

@section('content')
<div class="container-fluid">
    <div class="card shadow-sm" style="background-color: #ffe4c4;">
        <div class="card-body p-2">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.management.due-reports.balance-confirmation-letter-account-ledger') }}">
                <!-- Row 1: As On, Customer, Dr Balance Only, Status -->
                <div class="row g-2 mb-2 align-items-center">
                    ...
                    <div class="col-auto ms-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="dr_balance_only" id="dr_balance_only" {{ request('dr_balance_only') ? 'checked' : '' }}>
                            <label class="form-check-label fw-bold" for="dr_balance_only">Dr Balance Only</label>
                        </div>
                    </div>
                    <div class="col-auto">
                ...
                <!-- Row 2: Tagged Customer, Sales Man, Letter Date -->
                <div class="row g-2 mb-2 align-items-center">
                    <div class="col-auto">
...
function printReport() {
    window.open('{{ route("admin.reports.management.due-reports.balance-confirmation-letter-account-ledger") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
