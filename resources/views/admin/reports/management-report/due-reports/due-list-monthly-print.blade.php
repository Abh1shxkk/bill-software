...
<html>
<head>
    <title>Monthly Due List - Print</title>
    <style>
...
<body onload="window.print()">
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="{{ 4 + (request('address') ? 1 : 0) + (request('tel_no') ? 1 : 0) }}" class="text-center">No records found.</td></tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr>
