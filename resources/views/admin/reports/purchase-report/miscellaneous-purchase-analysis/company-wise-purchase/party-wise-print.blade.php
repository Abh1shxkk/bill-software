...
<html>
<head>
    <title>Company Wise Purchase - Party Wise Report</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="header">
        <h3>Company Wise Purchase - Party Wise</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ $party->total_bills }}</td>
                <td class="text-right">{{ number_format($party->total_qty, 2) }}</td>
                <td class="text-right">{{ number_format($party->total_amount, 2) }}</td>
                <td class="text-right">{{ number_format($party->total_net, 2) }}</td>
            </tr>
            @empty
        ...
        <tfoot>
            <tr class="total-row">
                ...
                <td class="text-right">{{ $grandBills }}</td>
