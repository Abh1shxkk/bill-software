...
@section('title', 'Supplier Wise - Item Invoice Wise')

@section('content')
<div class="container-fluid">
    <div class="card mb-2" style="background: linear-gradient(135deg, #f8d7da 0%, #f5c6cb 100%);">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 fst-italic fw-bold" style="color: #721c24;">SUPPLIER WISE - ITEM INVOICE WISE</h4>
        </div>
    </div>

    <div class="card shadow-sm mb-2">
        <div class="card-body py-2">
            <form method="GET" action="{{ route('admin.reports.purchase.misc.supplier.item-invoice-wise') }}" id="reportForm">
                ...
                <table class="table table-sm table-bordered table-striped table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold">{{ $item->item_name ?? 'N/A' }}</td>
...
function openPrintView() {
    ...
    const printUrl = "{{ route('admin.reports.purchase.misc.supplier.item-invoice-wise.print') }}?" + params;
