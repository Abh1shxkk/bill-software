...
<div class="container-fluid">
    ...
    <div class="card mb-2" style="background: linear-gradient(135deg, #e6e6fa 0%, #d8bfd8 100%);">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 text-dark fst-italic fw-bold">Day Purchase Summary - Item Wise</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-2">
        <div class="card-body py-2">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.purchase.day-purchase-summary') }}">
                <div class="row g-2">
                ...
                <table class="table table-sm table-hover table-bordered mb-0">
                    <thead class="table-dark sticky-top">
                        <tr>
                            ...
                            <th class="text-center" style="width: 90px;">PURCHASE</th>
                            @if(($showValue ?? 'Y') == 'Y')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if(($showValue ?? 'Y') == 'Y')
                            <td class="text-end">{{ number_format($item->total_value ?? 0, 2) }}</td>
                            @endif
        ...
        <div class="card-footer bg-light py-2">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 text-end">
                    ...
                    <span class="text-primary fw-bold fs-5 ms-4">{{ number_format($totals['value'] ?? 0, 2) }}</span>
                </div>
            </div>
        </div>
    </div>
