...
<head>
    ...
    <title>Stock Transfer Outgoing - Item - Bill Wise - Print</title>
    <style>
...
<body onload="window.print()">
    <div class="header">
        <h2>Stock Transfer Outgoing - Item - Bill Wise</h2>
    ...
    <table>
        <thead><tr><th class="text-center">S.No</th><th>Item Name</th><th>Date</th><th>Voucher No</th><th>Batch</th><th class="text-end">Qty</th><th class="text-end">Rate</th><th class="text-end">Amount</th></tr></thead>
        <tbody>
