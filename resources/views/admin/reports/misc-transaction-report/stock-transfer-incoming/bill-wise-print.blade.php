...
<head>
    ...
    <title>Stock Transfer Incoming - Bill Wise - Print</title>
    <style>
...
<body onload="window.print()">
    <div class="header">
        <h2>Stock Transfer Incoming - Bill Wise</h2>
    ...
    <table>
        <thead><tr><th class="text-center">S.No</th><th>Date</th><th>Voucher No</th><th>From Location</th><th class="text-end">Total Qty</th><th class="text-end">Total Amount</th></tr></thead>
        <tbody>
