...
<div class="container-fluid">
    ...
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2">
            <h4 class="mb-0 fst-italic" style="font-family: 'Times New Roman', serif; color: #800000;">GSTR4 - FOR COMPOSITE SCHEME (BETA VERSION)</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-2" style="background-color: #f0f0f0; border-radius: 0;">
        <div class="card-body py-2">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.gst.gstr-4') }}">
                <!-- Row 1 -->
                ...
                <div class="row g-2 align-items-center mt-1">
                    ...
                    <div class="col-auto ms-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="show_hsn" id="showHsn" value="1" {{ ($showHsn ?? false) ? 'checked' : '' }}>
                            <label class="form-check-label" for="showHsn">Show HSN</label>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-bordered mb-0" style="background-color: #ffffcc;">
                    ...
                    <tbody>
                        @if(!empty($reportData))
                        <tr>
                            <td class="fw-bold">Outward Supplies (Taxable)</td>
                        ...
                        <tr class="table-warning">
                            <td class="fw-bold">Tax Payable</td>
                        ...
                        <tr class="table-success">
                            <td class="fw-bold">Net Tax Payable</td>
                            <td class="text-center">-</td>
                            <td class="text-end fw-bold">{{ number_format($reportData['total_taxable'] ?? 0, 2) }}</td>
                            <td class="text-end fw-bold">{{ number_format($reportData['total_igst'] ?? 0, 2) }}</td>
                            <td class="text-end fw-bold">{{ number_format($reportData['total_cgst'] ?? 0, 2) }}</td>
    ...
    <div class="card shadow-sm mb-2" style="background-color: #f0f0f0; border-radius: 0;">
        <div class="card-body py-2">
            <div class="row align-items-center">
                <div class="col-auto">
                    <small class="text-primary"><i class="bi bi-folder me-1"></i>File Path : C:\EsTemp\GSTR4</small>
                </div>
...
$(document).ready(function() {
    ...
    $('#btnExcel').on('click', function() {
        window.location.href = '{{ route("admin.reports.gst.gstr-4") }}?export=excel&' + $('#filterForm').serialize();
    });
});
</script>
@endpush
