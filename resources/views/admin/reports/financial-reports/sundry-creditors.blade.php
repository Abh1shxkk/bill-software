...
@section('title', 'Sundry Creditors')
...
<div class="container-fluid">
    ...
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 fst-italic" style="font-family: 'Times New Roman', serif; color: #800080;">SUNDRY CREDITORS</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-2" style="background-color: #f0f0f0; border-radius: 0;">
        <div class="card-body py-3">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.financial.sundry-creditors') }}">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-2">
                        <select name="trial_head" class="form-select form-select-sm">
                            <option value="All" {{ ($trialHead ?? 'All') == 'All' ? 'selected' : '' }}>All</option>
...
function printReport() {
    window.open('{{ route("admin.reports.financial.sundry-creditors") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
