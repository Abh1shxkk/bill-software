...
<div class="container-fluid">
    ...
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 fst-italic" style="font-family: 'Times New Roman', serif; color: #800080;">SUNDRY DEBTORS</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-2" style="background-color: #f0f0f0; border-radius: 0;">
        <div class="card-body py-3">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.financial.sundry-debtors') }}">
...
function printReport() {
    window.open('{{ route("admin.reports.financial.sundry-debtors") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
