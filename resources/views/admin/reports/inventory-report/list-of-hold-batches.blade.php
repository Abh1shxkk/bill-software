...
@section('title', 'List of Hold Batches')

@section('content')
<div class="container-fluid">
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 text-primary fst-italic fw-bold" style="font-family: 'Times New Roman', serif;">List of hold Batches</h4>
        </div>
    </div>
        ...
        <div class="card-body p-3">
            <form method="GET" id="filterForm" action="">
                ...
                <div class="row g-2 mb-2 align-items-center">
                    <div class="col-auto">
                        <label class="fw-bold mb-0"><u>S</u>elective Item [ Y / N ] :</label>
                    </div>
                    <div class="col-auto">
                        <select name="selective_item" id="selective_item" class="form-select form-select-sm" style="width: 60px;">
                            <option value="N" {{ ($selectiveItem ?? 'N') == 'N' ? 'selected' : '' }}>N</option>
                            <option value="Y" {{ ($selectiveItem ?? '') == 'Y' ? 'selected' : '' }}>Y</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-2 mb-2 align-items-center">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="item_code" class="form-control form-control-sm" value="{{ $itemCode ?? '00' }}" style="width: 80px;">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-2 mb-2 align-items-center">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="company_code" class="form-control form-control-sm" value="{{ $companyCode ?? '00' }}" style="width: 80px;">
                    </div>
                    <div class="col-md-6">
