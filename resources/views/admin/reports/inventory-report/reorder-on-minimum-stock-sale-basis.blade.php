...
@section('title', 'Reorder on Minimum Stock & Sale Basis')

@section('content')
<div class="container-fluid">
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 text-primary fst-italic fw-bold" style="font-family: serif; letter-spacing: 1px;">REORDER ON MINIMUM STOCK & SALE BASIS</h4>
        </div>
    </div>
    ...
    <div class="card mt-3">
        <div class="card-header bg-primary text-white py-2">
            <strong>Reorder on Minimum Stock & Sale Basis Report</strong>
        </div>
