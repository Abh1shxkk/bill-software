...
<body>
    ...
    <div class="header">
        ...
        <p>Date: {{ request('date_from') }} to {{ request('date_to') }}</p>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">{{ number_format($row['variation'] ?? 0, 2) }}</td>
                <td class="text-end">{{ number_format($row['variation_percent'] ?? 0, 2) }}%</td>
            </tr>
            @empty
