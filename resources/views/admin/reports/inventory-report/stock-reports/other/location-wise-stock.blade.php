...
<div class="container-fluid">
    <div class="card mb-2" style="background-color: #d8bfd8;">
            ...
            <form method="GET" id="filterForm" action="{{ route('admin.reports.inventory.stock.location-wise-stock') }}">
                <div class="row g-2 mb-2 align-items-center">
                    <div class="col-md-2 text-end pe-2">
                        <label class="fw-bold mb-0">Enter Location :</label>
                    </div>
                    <div class="col-md-4">
                        <input type="text" name="location" class="form-control form-control-sm" value="{{ request('location', '') }}" placeholder="Enter location name">
                    </div>
                </div>
                <div class="row g-2 mb-2 align-items-center">
                    <div class="col-md-2 text-end pe-2">
    ...
    <div class="card mt-3">
        <div class="card-header bg-primary text-white py-2 d-flex justify-content-between">
            <strong>Location Wise Stock</strong>
            <div>
