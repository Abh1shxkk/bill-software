...
<div class="container-fluid">
    <div class="card mb-2" style="background-color: #ffc4d0;">
        <div class="card-body py-2 text-center">
            <h4 class="mb-0 text-primary fst-italic fw-bold" style="font-family: serif; letter-spacing: 1px;">Stock Register for IT Return</h4>
        </div>
    </div>

    <div class="card shadow-sm" style="background-color: #f0f0f0;">
        <div class="card-body p-3">
            <form method="GET" id="filterForm" action="{{ route('admin.reports.inventory.stock.stock-register-it-return') }}">
                <div class="row g-2 mb-2 align-items-center">
                    ...
                    <div class="col-md-4">
                        <select name="financial_year" class="form-select form-select-sm">
                            ...
                            <option value="2023-24" {{ request('financial_year') == '2023-24' ? 'selected' : '' }}>2023-24</option>
                        </select>
                    </div>
                </div>
                <div class="row g-2 mb-2 align-items-center">
