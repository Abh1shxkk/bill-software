...
<head>
    ...
    <style>
        ...
        .summary-box { background: #f8f9fa; padding: 10px; border-radius: 5px; text-align: center; width: 23%; }
        .summary-box h3 { margin: 0; color: #333; }
        .summary-box p { margin: 5px 0 0; font-size: 18px; font-weight: bold; color: #0d6efd; }
...
<body>
    ...
    <div class="summary" style="display: table; width: 100%;">
        ...
        <div style="display: table-cell; width: 25%; padding: 5px;">
            <div class="summary-box">
                <h3>Avg Sale</h3>
                <p>₹{{ $sales->count() > 0 ? number_format($totalSales / $sales->count(), 2) : '0.00' }}</p>
            </div>
        </div>
    </div>
    ...
    <table>
        ...
        <tfoot>
            <tr style="font-weight: bold; background: #f8f9fa;">
                ...
                <td class="text-end">₹{{ number_format($sales->sum('nt_amount'), 2) }}</td>
