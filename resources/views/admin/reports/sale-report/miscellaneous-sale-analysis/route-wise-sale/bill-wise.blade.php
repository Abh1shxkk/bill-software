        ...
        <form method="GET" id="filterForm">
            ...
            <fieldset class="border p-2 mb-3" style="background: #e8e8e8;">
                ...
                <div class="row g-2 mb-1">
                    ...
                    <div class="col-auto"><input type="checkbox" name="salesman_check" class="form-check-input"></div>
                </div>
                <div class="row g-2 mb-1">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto"><input type="checkbox" name="customer_check" class="form-check-input"></div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4"><label class="small">Series :</label><input type="text" name="series" class="form-control form-control-sm d-inline-block" value="{{ $series ?? '00' }}" style="width: 50px;"></div>
                <div class="col-auto ms-4"><label class="small">Flag :</label><input type="text" name="flag" class="form-control form-control-sm d-inline-block" value="{{ $flag ?? '' }}" style="width: 80px;"></div>
            </div>
