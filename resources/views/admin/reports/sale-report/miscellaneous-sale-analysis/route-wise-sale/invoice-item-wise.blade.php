...
@section('title', 'Route - Invoice - Item Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Route - Invoice - Item Wise Sale</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto" style="width: 130px;"><label class="small">Route :</label></div>
                <div class="col-auto"><input type="text" name="route_code" class="form-control form-control-sm" value="{{ $routeCode ?? '00' }}" style="width: 120px;"></div>
            ...
            <div class="row g-2 mb-1">
                <div class="col-auto" style="width: 130px;"><label class="small">Company :</label></div>
                <div class="col-auto"><input type="text" name="company_code" class="form-control form-control-sm" value="{{ $companyCode ?? '' }}" style="width: 120px;"></div>
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto" style="width: 130px;"><label class="small">Division :</label></div>
