...
<div class="container-fluid py-2">
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">Selective Y/N :</label><input type="text" name="selective" class="form-control form-control-sm d-inline-block" value="{{ $selective ?? 'N' }}" style="width: 35px;" maxlength="1"></div>
            </div>
