...
@section('title', 'Route Wise - Item Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">ROUTE WISE - ITEM WISE SALE</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            <div class="mb-2">
                ...
                <input type="text" name="transaction_type" class="form-control form-control-sm d-inline-block" value="{{ $transactionType ?? '3' }}" style="width: 35px;" maxlength="1">
            </div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">Selective Y/N :</label><input type="text" name="selective" class="form-control form-control-sm d-inline-block" value="{{ $selective ?? 'Y' }}" style="width: 35px;" maxlength="1"></div>
                <div class="col-auto ms-5"><label class="small">With Replacement Note :</label><input type="text" name="with_replacement" class="form-control form-control-sm d-inline-block" value="{{ $withReplacement ?? 'Y' }}" style="width: 35px;" maxlength="1"></div>
            </div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">C(ompany) / I(tem) :</label><input type="text" name="company_item" class="form-control form-control-sm d-inline-block" value="{{ $companyItem ?? 'C' }}" style="width: 35px;" maxlength="1"></div>
                <div class="col-auto ms-5"><label class="small">T(ax) / R(etail) :</label><input type="text" name="tax_retail" class="form-control form-control-sm d-inline-block" value="{{ $taxRetail ?? '' }}" style="width: 35px;" maxlength="1"></div>
            </div>

            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">Tagged Companies [ Y / N ] :</label><input type="text" name="tagged_companies" class="form-control form-control-sm d-inline-block" value="{{ $taggedCompanies ?? 'N' }}" style="width: 35px;" maxlength="1"></div>
                <div class="col-auto ms-4"><label class="small">Remove Tags [ Y / N ] :</label><input type="text" name="remove_tags" class="form-control form-control-sm d-inline-block" value="{{ $removeTags ?? 'N' }}" style="width: 35px;" maxlength="1"></div>
            </div>

            <div class="row g-2 mb-1">
                <div class="col-auto" style="width: 100px;"><label class="small">Company :</label></div>
                <div class="col-auto"><input type="text" name="company_code" class="form-control form-control-sm" value="{{ $companyCode ?? '00' }}" style="width: 120px;"></div>
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-auto"><input type="text" name="division_code" class="form-control form-control-sm" value="{{ $divisionCode ?? '00' }}" style="width: 120px;"></div>
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto" style="width: 100px;"><label class="small">Item Category :</label></div>
                <div class="col-auto"><input type="text" name="item_category_code" class="form-control form-control-sm" value="{{ $itemCategoryCode ?? '00' }}" style="width: 120px;"></div>
                <div class="col-md-4"><select name="item_category_id" class="form-select form-select-sm"><option value="">-- All --</option>@foreach($itemCategories ?? [] as $ic)<option value="{{ $ic->id }}" {{ ($itemCategoryId ?? '') == $ic->id ? 'selected' : '' }}>{{ $ic->name }}</option>@endforeach</select></div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-5"><label class="small">Item Status :</label><input type="text" name="item_status" class="form-control form-control-sm d-inline-block" value="{{ $itemStatus ?? '' }}" style="width: 80px;"></div>
            </div>

            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">With Batch Details [ Y / N ] :</label><input type="text" name="with_batch" class="form-control form-control-sm d-inline-block" value="{{ $withBatch ?? 'Y' }}" style="width: 35px;" maxlength="1"></div>
            </div>
