...
@section('title', 'Route Wise - Month Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">ROUTE WISE - MONTH WISE SALE</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto"><label class="small">Sales in: 1. (Thousand) / 2. (Ten Thousand) / 3. (Lacs) / 4. (Actual) :</label><input type="text" name="sales_in" class="form-control form-control-sm d-inline-block" value="{{ $salesIn ?? '4' }}" style="width: 35px;" maxlength="1"></div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4"><label class="small">With DN / CN [ Y / N ] :</label><input type="text" name="with_dn_cn" class="form-control form-control-sm d-inline-block" value="{{ $withDnCn ?? 'Y' }}" style="width: 35px;" maxlength="1"></div>
            </div>
