...
@section('title', 'Route / Item - Month Wise')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Route / Item - Month wise</h4>
    </div>

    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small fw-bold"><u>F</u>rom :</label><input type="text" name="year_from" class="form-control form-control-sm" value="{{ $yearFrom ?? date('Y') }}" style="width: 80px;"></div>
                <div class="col-auto ms-3"><label class="small fw-bold">To :</label><input type="text" name="year_to" class="form-control form-control-sm" value="{{ $yearTo ?? (date('Y') + 1) }}" style="width: 80px;"></div>
            </div>

            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">Sales in: 1. (Thousand) / 2. (Ten Thousand) / 3. (Lacs) / 4. (Actual) :</label><input type="text" name="sales_in" class="form-control form-control-sm d-inline-block" value="{{ $salesIn ?? '1' }}" style="width: 35px;" maxlength="1"></div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4"><label class="small">Division :</label><input type="text" name="division_code" class="form-control form-control-sm d-inline-block" value="{{ $divisionCode ?? '00' }}" style="width: 80px;"></div>
            </div>

            <div class="row g-2 mb-2">
                <div class="col-auto" style="width: 100px;"><label class="small">Company :</label></div>
                <div class="col-auto"><input type="text" name="company_yn" class="form-control form-control-sm" value="{{ $companyYn ?? 'Y' }}" style="width: 35px;" maxlength="1"></div>
