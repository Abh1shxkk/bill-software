...
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Route Wise Sales</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-auto"><input type="text" name="salesman_code" class="form-control form-control-sm" value="{{ $salesmanCode ?? '00' }}" style="width: 50px;"></div>
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-auto"><input type="text" name="area_code" class="form-control form-control-sm" value="{{ $areaCode ?? '00' }}" style="width: 50px;"></div>
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-auto"><input type="text" name="route_code" class="form-control form-control-sm" value="{{ $routeCode ?? '00' }}" style="width: 50px;"></div>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto"><input type="text" name="state_code" class="form-control form-control-sm" value="{{ $stateCode ?? '00' }}" style="width: 50px;"></div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto"><label class="small">Order By N(ame) / V(alue) :</label><input type="text" name="order_by" class="form-control form-control-sm d-inline-block" value="{{ $orderBy ?? 'N' }}" style="width: 35px;" maxlength="1"></div>
                <div class="col-auto ms-5"><label class="small">A(scending) / D(escending) :</label><input type="text" name="sort_order" class="form-control form-control-sm d-inline-block" value="{{ $sortOrder ?? 'A' }}" style="width: 35px;" maxlength="1"></div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-5"><label class="small">Series :</label><input type="text" name="series" class="form-control form-control-sm d-inline-block" value="{{ $series ?? '00' }}" style="width: 50px;"></div>
            </div>

            <div class="row g-2 mt-3 pt-2 border-top">
                <div class="col-auto"><button type="button" class="btn btn-light btn-sm border px-4" id="btnExcel"><u>E</u>xcel</button></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btnExcel').addEventListener('click', function() {
        let ei = form.querySelector('input[name="export"]');
        if (!ei) { ei = document.createElement('input'); ei.type = 'hidden'; ei.name = 'export'; form.appendChild(ei); }
        ei.value = 'excel'; form.submit(); ei.value = '';
    });
