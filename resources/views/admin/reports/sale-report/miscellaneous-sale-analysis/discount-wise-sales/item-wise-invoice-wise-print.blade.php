...
<head>
    ...
    <title>Discount Wise - Item Wise Invoice Wise Report</title>
    <style>
...
<body>
    <div class="header">
        <h2>DISCOUNT WISE - ITEM WISE INVOICE WISE REPORT</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($row['discount_percent'] ?? 0, 2) }}</td>
                <td class="text-right">{{ number_format($row['discount_amount'] ?? 0, 2) }}</td>
            ...
            <tr class="total-row">
                ...
                <td class="text-right"></td>
                <td class="text-right">{{ number_format($totals['discount_amount'] ?? 0, 2) }}</td>
