...
@section('title', 'Customer Wise Sale - All Customer')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">CUSTOMER WISE SALE - ALL CUSTOMER</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto">
                    <input type="text" name="transaction_type" class="form-control form-control-sm" value="5" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="selective" class="form-control form-control-sm d-inline-block" value="S" style="width: 35px;" maxlength="1">
                </div>
            </div>
