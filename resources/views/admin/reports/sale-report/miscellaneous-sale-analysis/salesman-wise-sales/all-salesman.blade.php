    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            <div class="mb-2">
                ...
                <input type="text" name="transaction_type" class="form-control form-control-sm d-inline-block" 
                       value="{{ $transactionType ?? '5' }}" style="width: 35px;">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="tagged_salesman" class="form-control form-control-sm d-inline-block" 
                       value="{{ $taggedSalesman ?? 'N' }}" style="width: 35px;">
            </div>
            ...
            <div class="row g-2 mb-1">
                <div class="col-auto">
                    ...
                    <input type="text" name="order_by" class="form-control form-control-sm d-inline-block" value="{{ $orderBy ?? 'N' }}" style="width: 35px;">
                </div>
                <div class="col-auto">
                    <label class="small">A(scending) / D(esending) :</label>
                    <input type="text" name="asc_desc" class="form-control form-control-sm d-inline-block" value="{{ $ascDesc ?? 'A' }}" style="width: 35px;">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto">
                    ...
                    <select name="series" class="form-select form-select-sm d-inline-block" style="width: 80px;">
                        <option value="">All</option>
                        @foreach($seriesList ?? [] as $sr)
                            <option value="{{ $sr }}" {{ ($series ?? '') == $sr ? 'selected' : '' }}>{{ $sr }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
