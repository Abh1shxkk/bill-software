...
@section('title', 'Sales Man / Item - Month wise')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Sales Man / Item - Month wise</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-1">
                <div class="col-auto" style="width: 160px;"><label class="small">Tagged Companies [ Y / N ] :</label></div>
                <div class="col-auto">
                    <input type="text" name="tagged_companies" class="form-control form-control-sm" value="{{ $taggedCompanies ?? 'N' }}" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-3" style="width: 80px;"><label class="small">Division :</label></div>
                <div class="col-md-2">
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-auto">
                    <input type="text" class="form-control form-control-sm" value="Y" style="width: 35px;" disabled>
                </div>
                <div class="col-md-4">
