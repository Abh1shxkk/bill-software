...
@section('title', 'Area - Invoice - Item Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Area - Invoice - Item Wise Sale</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto">
                    <input type="text" name="company_code" class="form-control form-control-sm" value="{{ $companyCode ?? '' }}" style="width: 50px;">
                </div>
                <div class="col-md-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btnExcel').addEventListener('click', function() {
        ...
        exp.value = 'excel'; form.submit(); exp.value = '';
    });
