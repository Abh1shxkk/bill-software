        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-3">
                    ...
                    <select name="series" class="form-select form-select-sm d-inline-block" style="width: 70px;">
