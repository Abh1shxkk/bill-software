...
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Area Wise Sales</h4>
    </div>
        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="sort_order" class="form-control form-control-sm d-inline-block" value="{{ $sortOrder ?? 'A' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
