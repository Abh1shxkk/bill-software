    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto">
                    <input type="text" name="area_code" class="form-control form-control-sm" value="{{ $areaCode ?? '' }}" style="width: 120px;">
                </div>
                <div class="col-md-4">
            ...
            <fieldset class="border p-2 mb-3" style="background: #e8e8e8;">
                ...
                <div class="row g-2 mb-1">
                    <div class="col-auto" style="width: 80px;"><label class="small">Area :</label></div>
                    <div class="col-auto">
                        <input type="text" name="filter_area_code" class="form-control form-control-sm" value="{{ $filterAreaCode ?? '00' }}" style="width: 50px;">
                    </div>
                    <div class="col-md-4">
                        <select name="filter_area_id" class="form-select form-select-sm">
                            <option value="">-- All --</option>
                            @foreach($areas ?? [] as $a)
                                <option value="{{ $a->id }}" {{ ($filterAreaId ?? '') == $a->id ? 'selected' : '' }}>{{ $a->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto" style="width: 80px;"><label class="small">Customer :</label></div>
                <div class="col-auto">
                    <input type="text" name="customer_code" class="form-control form-control-sm" value="{{ $customerCode ?? '00' }}" style="width: 50px;">
                </div>
                <div class="col-md-4">
