...
<div class="container-fluid py-2">
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto" style="width: 80px;"><label class="small" style="color: #8B0000;">Area :</label></div>
                <div class="col-auto">
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto">
                    ...
                    <input type="text" name="selective_item" class="form-control form-control-sm d-inline-block" value="{{ $selectiveItem ?? 'Y' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>

            <div class="row g-2 mb-3">
                <div class="col-auto" style="width: 80px;"><label class="small">Item :</label></div>
                <div class="col-auto">
                    <input type="text" name="item_code" class="form-control form-control-sm" value="{{ $itemCode ?? '' }}" style="width: 120px;">
                </div>
                <div class="col-md-4">
