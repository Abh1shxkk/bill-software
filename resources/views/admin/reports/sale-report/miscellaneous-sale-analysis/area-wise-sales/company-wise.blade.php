...
@section('title', 'Area Wise - Company Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">AREA WISE - COMPANY WISE SALE</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto" style="width: 80px;"><label class="small">Company :</label></div>
                <div class="col-auto">
                    <input type="text" name="company_code" class="form-control form-control-sm" value="{{ $companyCode ?? '00' }}" style="width: 50px;">
                </div>
                <div class="col-md-4">
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto" style="width: 80px;"><label class="small">Division :</label></div>
                <div class="col-auto">
                    <input type="text" name="division_code" class="form-control form-control-sm" value="{{ $divisionCode ?? '00' }}" style="width: 50px;">
                </div>
                <div class="col-md-4">
