        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="selective" class="form-control form-control-sm d-inline-block" value="{{ $selective ?? 'N' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
