        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="sales_in" class="form-control form-control-sm d-inline-block" value="{{ $salesIn ?? '1' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="division_code" class="form-control form-control-sm d-inline-block" value="{{ $divisionCode ?? '00' }}" style="width: 50px;">
                </div>
            </div>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto">
                    <input type="text" name="company_selective" class="form-control form-control-sm" value="{{ $companySelective ?? 'Y' }}" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto">
            ...
            <fieldset class="border p-2 mb-3" style="background: #e8e8e8;">
                <legend class="small text-muted fw-bold w-auto px-2" style="font-size: 11px; color: #8B0000;">Filters</legend>
