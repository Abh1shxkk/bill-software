...
<head>
    ...
    <title>State - Route Wise Sales Report</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h2>State - Route Wise Sales Report</h2>
            <p>From: {{ \Carbon\Carbon::parse($dateFrom)->format('d-M-Y') }} To: {{ \Carbon\Carbon::parse($dateTo)->format('d-M-Y') }}</p>
        </div>
        <table>
            <thead>
                <tr><th>State</th><th>Route</th><th class="text-center">Bills</th><th class="text-right">Gross Amt</th><th class="text-right">Discount</th><th class="text-right">Net Amt</th></tr>
            </thead>
            <tbody>
