...
@section('title', 'State - Customer Wise Sales')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">STATE - CUSTOMER WISE SALES</h4>
    </div>
        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="selective" class="form-control form-control-sm d-inline-block" value="{{ $selective ?? 'S' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="tagged_customers" class="form-control form-control-sm d-inline-block" value="{{ $taggedCustomers ?? 'N' }}" style="width: 35px;" maxlength="1">
                </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto"><input type="text" name="customer_code" class="form-control form-control-sm" value="{{ $customerCode ?? '00' }}" style="width: 60px;"></div>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="flag" class="form-control form-control-sm d-inline-block" value="{{ $flag ?? '' }}" style="width: 80px;">
                </div>
            </div>
