        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="flag" class="form-control form-control-sm d-inline-block" value="{{ $flag ?? '' }}" style="width: 50px;">
                </div>
            </div>
