...
@section('title', 'State Wise - Item Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">STATE WISE - ITEM WISE SALE</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0f0f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto">
                    <input type="text" name="transaction_type" class="form-control form-control-sm" value="{{ $transactionType ?? '3' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            {{-- Selective & With Replacement Note --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                ...
                <div class="col-auto ms-4">
                    <label class="small">With Replacement Note :</label>
                    <input type="text" name="with_replacement" class="form-control form-control-sm d-inline-block" value="{{ $withReplacement ?? 'Y' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto"><input type="text" name="state_code" class="form-control form-control-sm" value="{{ $stateCode ?? '' }}" style="width: 60px;"></div>
            ...
            {{-- Company/Item & Tax/Retail --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">C (ompany) / I (tem) :</label>
                    <input type="text" name="company_item" class="form-control form-control-sm d-inline-block" value="{{ $companyItem ?? 'C' }}" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">T(ax) / R(etail) :</label>
                    <input type="text" name="tax_retail" class="form-control form-control-sm d-inline-block" value="{{ $taxRetail ?? '' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="tagged_companies" class="form-control form-control-sm d-inline-block" value="{{ $taggedCompanies ?? 'N' }}" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">Remove Tags [ Y / N ] :</label>
                    <input type="text" name="remove_tags" class="form-control form-control-sm d-inline-block" value="{{ $removeTags ?? 'N' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>

            {{-- Company/Division/Item Category --}}
            <div class="row g-2 mb-1">
                <div class="col-auto" style="width: 110px;"><label class="small">Company:</label></div>
                <div class="col-auto"><input type="text" name="company_code" class="form-control form-control-sm" value="{{ $companyCode ?? '00' }}" style="width: 60px;"></div>
                <div class="col-md-4"><select name="company_id" class="form-select form-select-sm"><option value="">-- All --</option>@foreach($companies ?? [] as $c)<option value="{{ $c->id }}" {{ ($companyId ?? '') == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>@endforeach</select></div>
            </div>
            <div class="row g-2 mb-1">
                <div class="col-auto" style="width: 110px;"><label class="small">Division:</label></div>
                <div class="col-auto"><input type="text" name="division_code" class="form-control form-control-sm" value="{{ $divisionCode ?? '00' }}" style="width: 60px;"></div>
                <div class="col-md-4"><select name="division_id" class="form-select form-select-sm"><option value="">-- All --</option>@foreach($divisions ?? [] as $d)<option value="{{ $d->id }}" {{ ($divisionId ?? '') == $d->id ? 'selected' : '' }}>{{ $d->name }}</option>@endforeach</select></div>
            </div>
            <div class="row g-2 mb-3">
                <div class="col-auto" style="width: 110px;"><label class="small">Item Category:</label></div>
                <div class="col-auto"><input type="text" name="category_code" class="form-control form-control-sm" value="{{ $categoryCode ?? '00' }}" style="width: 60px;"></div>
                <div class="col-md-4"><select name="category_id" class="form-select form-select-sm"><option value="">-- All --</option>@foreach($categories ?? [] as $cat)<option value="{{ $cat->id }}" {{ ($categoryId ?? '') == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>@endforeach</select></div>
            </div>
            ...
            <fieldset class="border p-2 mb-3" style="background: #e8e8e8;">
                ...
                <div class="row g-2">
                    <div class="col-auto" style="width: 100px;"><label class="small">State:</label></div>
                    <div class="col-auto"><input type="text" name="filter_state_code" class="form-control form-control-sm" value="{{ $filterStateCode ?? '00' }}" style="width: 60px;"></div>
                    <div class="col-md-4"><select name="filter_state_id" class="form-select form-select-sm"><option value="">-- All --</option>@foreach($states ?? [] as $s)<option value="{{ $s->id }}" {{ ($filterStateId ?? '') == $s->id ? 'selected' : '' }}>{{ $s->name }}</option>@endforeach</select></div>
                </div>
            </fieldset>

            {{-- With Br./Expiry & Item Status --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="item_status" class="form-control form-control-sm d-inline-block" value="{{ $itemStatus ?? '' }}" style="width: 80px;">
                </div>
            </div>
            ...
            <div class="row g-2 mb-3">
                <div class="col-auto">
                    <label class="small">With Batch Details [ Y / N ] :</label>
                    <input type="text" name="with_batch_details" class="form-control form-control-sm d-inline-block" value="{{ $withBatchDetails ?? 'Y' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>
