...
@section('title', 'State - Invoice - Item Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">State - Invoice - Item Wise Sale</h4>
    </div>
        ...
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    ...
                    <input type="text" name="selective" class="form-control form-control-sm d-inline-block" value="Y" style="width: 35px;" maxlength="1">
                </div>
            </div>
