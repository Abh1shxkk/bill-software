...
@section('title', 'Company - Customer - Item wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Company - Customer - Item wise Sale</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0e8f0;">
        <form method="GET" id="filterForm">
            ...
            {{-- S(ale) / R(eturn) / B(oth) & Sale on Challan --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">S(ale) / R(eturn) / B(oth) :</label>
                    <input type="text" name="transaction_type" class="form-control form-control-sm d-inline-block" value="B" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">Sale on Challan [ Y / N ] :</label>
                    <input type="text" name="sale_on_challan" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
            </div>

            {{-- Tagged Company Only & Remove Tags --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">Tagged Company Only [ Y / N ] :</label>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4">
                    <label class="small">With Transfer Note</label>
                    <input type="checkbox" name="with_transfer_note" class="form-check-input ms-2">
                </div>
            </div>

            {{-- Tagged Parties Only & Remove Tags --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">Tagged Parties Only [ Y / N ] :</label>
                    <input type="text" name="tagged_parties" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">Remove Tags [ Y / N ] :</label>
                    <input type="text" name="remove_party_tags" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
            </div>

            {{-- Customer --}}
            <div class="row g-2 mb-2">
                <div class="col-auto" style="width: 120px;"><label class="small">Customer :</label></div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto">
                    <label class="small">Value on Pur.Rate/ Cost / Mrp [ P / C / M / N ] :</label>
                    <input type="text" name="value_on" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
            </div>

            {{-- Add Gst & DPC Item & Group By --}}
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto ms-5">
                    ...
                    <select name="group_by" class="form-select form-select-sm d-inline-block" style="width: 100px;">
