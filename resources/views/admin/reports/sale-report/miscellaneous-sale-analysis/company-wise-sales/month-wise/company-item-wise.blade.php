...
@section('title', 'Company / Item - Month wise')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #8B0000;">Company / Item - Month wise</h4>
    </div>
    ...
    <div class="border p-3" style="background: #f0e8f0;">
        <form method="GET" id="filterForm">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto">
                    <input type="text" name="sales_in" class="form-control form-control-sm" value="{{ $salesIn ?? '1' }}" style="width: 35px;" maxlength="1">
                </div>
            </div>

            {{-- Tagged Companies & Division --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="division_code" class="form-control form-control-sm d-inline-block" value="00" style="width: 60px;">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto"><input type="text" name="company_code" class="form-control form-control-sm" value="Y" style="width: 40px;"></div>
            ...
            {{-- Tagged Customer & Remove Tag Customer --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">Tagged Customer [ Y / N ] :</label>
                    <input type="text" name="tagged_customer" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">Remove Tag Customer [ Y / N ] :</label>
                    <input type="text" name="remove_tag_customer" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="flag" class="form-control form-control-sm d-inline-block" value="" style="width: 80px;">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">Status :</label>
                    <input type="text" name="status" class="form-control form-control-sm d-inline-block" value="" style="width: 80px;">
                </div>
            </div>
