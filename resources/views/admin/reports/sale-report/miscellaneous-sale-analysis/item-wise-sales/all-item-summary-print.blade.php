...
<head>
    ...
    <title>Item Wise Sale Summary</title>
    <style>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-right" style="width: 100px;">Gross Amt</th>
                <th class="text-right" style="width: 100px;">Tax Amt</th>
                <th class="text-right" style="width: 100px;">Net Amt</th>
            </tr>
        </thead>
        <tbody>
