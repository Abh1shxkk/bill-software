...
@section('title', 'Item Wise Sale')

@section('content')
<div class="container-fluid py-2">
    <div class="text-center py-2 mb-2" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border: 1px solid #ccc;">
        <h4 class="mb-0 fst-italic fw-bold" style="color: #800080;">Item Wise Sale</h4>
    </div>

    <div class="border p-3" style="background: #f0e8f0;">
        <form method="GET" id="filterForm" action="{{ route('admin.reports.sales.item-wise-sales.bill-wise') }}">
            {{-- Transaction Type --}}
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">Selective Item [ Y / N ] :</label>
                    <input type="text" name="selective_item" class="form-control form-control-sm d-inline-block" value="Y" style="width: 35px;" maxlength="1">
                </div>
                <div class="col-auto ms-4">
            ...
            <div class="row g-2 mb-2">
                <div class="col-auto">
                    <label class="small">Tagged Items [ Y / N ] :</label>
            ...
            <div class="row g-2 mb-1">
                <div class="col-auto" style="width: 100px;"><label class="small text-danger">Item :</label></div>
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="batch" class="form-control form-control-sm d-inline-block" value="" style="width: 100px;">
                </div>
            </div>

            {{-- Party Code --}}
            <div class="row g-2 mb-2">
                <div class="col-auto" style="width: 100px;"><label class="small">Party Code :</label></div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4">
                    <label class="small">With Pur. Ref. [ Y / N ] :</label>
                    <input type="text" name="with_pur_ref" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
            </div>

            {{-- With Address & With Value --}}
            <div class="row g-2 mb-2">
                <div class="col-auto">
                ...
                <div class="col-auto ms-4">
                    <label class="small">With Value [ Y / N ] :</label>
                    <input type="text" name="with_value" class="form-control form-control-sm d-inline-block" value="N" style="width: 35px;" maxlength="1">
                </div>
            </div>
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-auto ms-4">
                    ...
                    <input type="text" name="item_type" class="form-control form-control-sm d-inline-block" value="00" style="width: 60px;">
                </div>
            </div>

            {{-- Item Status & Group By --}}
            <div class="row g-2 mb-3">
                <div class="col-auto">
                    <label class="small">Item Status :</label>
                    <input type="text" name="item_status" class="form-control form-control-sm d-inline-block" value="" style="width: 100px;">
                </div>
                <div class="col-auto ms-4">
                    <label class="small">Group By :</label>
                    <select name="group_by" class="form-select form-select-sm d-inline-block" style="width: 120px;">
