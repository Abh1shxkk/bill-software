...
<head>
    ...
    <title>TDS Input Report - Print</title>
    <style>
...
<body>
    ...
    <div class="filters">
        ...
        @if($customerId)<span><strong>Customer:</strong> {{ $customers->firstWhere('id', $customerId)->name ?? 'N/A' }}</span>@endif
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-center" style="width: 50px;">TDS%</th>
                <th class="text-end" style="width: 80px;">TDS Amt</th>
            </tr>
        </thead>
        <tbody>
