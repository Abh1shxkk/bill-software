        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center" style="background-color: #ffc4d0; font-style: italic; font-family: 'Times New Roman', Times, serif;">
                    <h5 class="mb-0">Godown Brk/Expiry Item Wise - Disallowed Items</h5>
                </div>
                <div class="card-body" style="background-color: #f0f0f0; border-radius: 0;">
                    <form method="GET" id="filterForm">
                        ...
                        <div class="row g-2 align-items-end mt-1">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('admin.reports.breakage-expiry.godown-item-wise.disallowed-items') }}" class="btn btn-secondary btn-sm">Close</a>
                            </div>
                        </div>
                    </form>
                </div>
...
function printReport() {
    window.open('{{ route("admin.reports.breakage-expiry.godown-item-wise.disallowed-items") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
</script>
@endsection
