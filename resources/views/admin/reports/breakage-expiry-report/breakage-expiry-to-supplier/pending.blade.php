        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center" style="background-color: #ffc4d0; font-style: italic; font-family: 'Times New Roman', Times, serif;">
                    <h5 class="mb-0">Breakage/Expiry To Supplier - Pending</h5>
                </div>
            ...
            <div class="card mt-2">
                <div class="card-body p-0">
                    ...
                    <div class="d-flex justify-content-between p-2" style="background-color: #90EE90; font-size: 12px;">
                        ...
                        <span>Total : <span class="text-danger">{{ number_format($totalAmount ?? 0, 2) }}</span></span>
                    </div>
                </div>
            </div>
        </div>
...
function printReport() {
    window.open('{{ route("admin.reports.breakage-expiry.to-supplier.pending") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
