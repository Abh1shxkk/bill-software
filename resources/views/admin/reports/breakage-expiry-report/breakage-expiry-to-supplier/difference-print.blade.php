...
<head>
    <meta charset="UTF-8">
    <title>Breakage/Expiry To Supplier - Difference - Print</title>
    <style>
...
<body>
    <div class="header">
        <h2>Breakage/Expiry To Supplier - Difference</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">{{ ($row->issued_qty ?? 0) - ($row->received_qty ?? 0) }}</td>
