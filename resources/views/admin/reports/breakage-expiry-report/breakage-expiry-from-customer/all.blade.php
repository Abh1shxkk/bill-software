        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center" style="background-color: #ffc4d0; font-style: italic; font-family: 'Times New Roman', Times, serif;">
                    <h5 class="mb-0">Breakage/Expiry From Customer - All</h5>
                </div>
...
function printReport() {
    window.open('{{ route("admin.reports.breakage-expiry.from-customer.all") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
