        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header text-center" style="background-color: #ffc4d0; font-style: italic; font-family: 'Times New Roman', Times, serif;">
                    <h5 class="mb-0">EXPIRY / BREAKAGE RETURN TO<br>SUPPLIER</h5>
                </div>
                <div class="card-body" style="background-color: #f0f0f0; border-radius: 0;">
                    <form method="GET" id="filterForm">
                        ...
                        <div class="row g-2 align-items-center mb-2">
                            ...
                            <div class="col-auto">
                                <input type="text" name="company_code" class="form-control form-control-sm" style="width: 50px;" value="{{ request('company_code') }}">
                            </div>
                            <div class="col">
                        ...
                        <div class="row g-2 align-items-center mb-3">
                            ...
                            <div class="col-auto">
                                <input type="text" name="supplier_code" class="form-control form-control-sm" style="width: 50px;" value="{{ request('supplier_code', '00') }}">
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <a href="{{ route('admin.reports.breakage-expiry.company-wise.to-supplier') }}" class="btn btn-secondary btn-sm">Close</a>
                            </div>
                        </div>
                    </form>
                </div>
...
function printReport() {
    window.open('{{ route("admin.reports.breakage-expiry.company-wise.to-supplier") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
</script>
@endsection
