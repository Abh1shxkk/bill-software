        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header text-center" style="background-color: #ffc4d0; font-style: italic; font-family: 'Times New Roman', Times, serif;">
                    <h5 class="mb-0">EXPIRY / BREAKAGE RETURN FROM<br>CUSTOMER</h5>
                </div>
                    ...
                    <form method="GET" id="filterForm">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <a href="{{ route('admin.reports.breakage-expiry.company-wise.from-customer') }}" class="btn btn-secondary btn-sm">Close</a>
                            </div>
                        </div>
                    </form>
                </div>
...
function printReport() {
    window.open('{{ route("admin.reports.breakage-expiry.company-wise.from-customer") }}?print=1&' + $('#filterForm').serialize(), '_blank');
}
</script>
@endsection
