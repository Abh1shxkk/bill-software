        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center" style="background-color: #ffc4d0; font-style: italic; font-family: 'Times New Roman', Times, serif;">
                    <h5 class="mb-0">Replacement From Supplier - All</h5>
                </div>
                <div class="card-body" style="background-color: #f0f0f0; border-radius: 0;">
                    <form method="GET" id="filterForm">
                            ...
                            <div class="col-md-2">
                                <select name="party_id" class="form-select form-select-sm">
                                    ...
                                    @foreach($suppliers ?? [] as $supplier)
                                        <option value="{{ $supplier->id }}" {{ request('party_id') == $supplier->id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row g-2 align-items-end mt-1">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('admin.reports.breakage-expiry.replacement-from-supplier') }}" class="btn btn-secondary btn-sm">Close</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="table table-bordered table-sm mb-0" style="font-size: 12px;">
                            ...
                            <tbody>
                                ...
                                <tr style="{{ $index == 0 ? 'background-color: #000080; color: white;' : '' }}">
                                    ...
                                    <td>{{ number_format($row->final_amount ?? 0, 2) }}</td>
                                </tr>
                                @empty
                                @for($i = 1; $i <= 17; $i++)
