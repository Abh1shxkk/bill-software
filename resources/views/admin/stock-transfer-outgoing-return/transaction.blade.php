                ...
                <div class="row g-2">
                    <div class="col-md-2">
                        <div class="field-group">
                            <label>Date:</label>
                            <input type="date" class="form-control form-control-sm" id="stor_transaction_date" name="transaction_date" style="width: 130px;" value="{{ date('Y-m-d') }}" data-custom-enter>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="field-group">
            ...
            <div class="gr-section">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="field-group">
                            <label>GR Date:</label>
                            <input type="date" class="form-control form-control-sm" id="stor_gr_date" name="gr_date" style="width: 130px;" value="{{ date('Y-m-d') }}" data-custom-enter>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="field-group">
