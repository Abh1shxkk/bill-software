...
<script>
// ============================================================
// AUTO-SAVE  —  credit_note_transaction_autosave_v1
// ============================================================
(function(){
'use strict';
const KEY = 'credit_note_transaction_autosave_v1';
let _t = null;
...
function save(){
    ...
    const state={
        ...
        reason:_val('reason'),
        reasonDisplay:_val('reasonDisplay'),
...
document.addEventListener('DOMContentLoaded',function(){
    // Patch markAsSaving → clear draft (called right before save fetch in both modes)
    setTimeout(function(){
